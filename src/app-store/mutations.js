...
const deprecatedParamsConfigJson = {
        ...
        "Portalconfig.mapView.startResolution": [
            "Portalconfig.mapView.resolution",
        ],
        "Portalconfig.mapView.startZoomLevel": [
            "Portalconfig.mapView.zoomLevel",
        ],
        "Portalconfig.menu.tools.children.fileImport": [
            "Portalconfig.menu.tools.children.kmlimport",
            "Portalconfig.Portalconfig.menu.kmlimport",
        ],
        "Portalconfig.menu.tools.children.supplyCoord": [
            "Portalconfig.menu.tools.children.coord",
            "Portalconfig.Portalconfig.menu.coord",
        ],
    },
...
export default {
    ...
    setConfigJson(state, config) {
        state.configJson = actions.checkWhereDeprecated(
            deprecatedParamsConfigJson,
            config
        );
    },
    /**
    ...
    setConfigJs(state, config) {
        state.configJs = actions.checkWhereDeprecated(
            deprecatedParamsConfigJs,
            config
        );
    },
