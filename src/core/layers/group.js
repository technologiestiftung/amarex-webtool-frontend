...
import WMSLayer from "./wms.js";
import WFSLayer from "./wfs.js";
import WMTSLayer from "./wmts.js";
import GeoJSONLayer from "./geojson.js";
import OAFLayer from "./oaf.js";
import STALayer from "./sta.js";
...
GroupedLayers.prototype.showLayerInformation = function () {
    ...
    if (
        ...
        typeof this.prepareLayerObject === "function"
    ) {
    ...
    this.get("children").forEach((layer) => {
        ...
        if (
            layer.datasets &&
            Array.isArray(layer.datasets) &&
            layer.datasets[0] !== null &&
            typeof layer.datasets[0] === "object"
        ) {
            cswUrl = Object.prototype.hasOwnProperty.call(
                layer.datasets[0],
                "csw_url"
            )
                ? layer.datasets[0].csw_url
                : null;
            showDocUrl = Object.prototype.hasOwnProperty.call(
                layer.datasets[0],
                "show_doc_url"
            )
                ? layer.datasets[0].show_doc_url
                : null;
            layerMetaId = Object.prototype.hasOwnProperty.call(
                layer.datasets[0],
                "md_id"
            )
                ? layer.datasets[0].md_id
                : null;
        }
...
GroupedLayers.prototype.checkForScale = function (options) {
    if (this.get("checkForScale") !== false) {
        ...
        if (
            currentScale > parseInt(this.get("maxScale"), 10) ||
            currentScale < parseInt(this.get("minScale"), 10)
        ) {
            ...
            this.get("children").forEach((layerSource) => {
                if (
                    currentScale <=
                        parseInt(
                            layerSource.maxScale || this.get("maxScale"),
                            10
                        ) &&
                    currentScale >=
                        parseInt(
                            layerSource.minScale || this.get("minScale"),
                            10
                        )
                ) {
        ...
        this.set(
            "isOutOfRange",
            groupLayerIsOutOfRange || childLayersAreOutOfRange
        );
