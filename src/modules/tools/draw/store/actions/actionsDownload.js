...
import convertFeaturesToKml from "../../../../../utils/convertFeaturesToKml.js";
...
import {
    ...
    transformPoint,
    transformGeometry,
} from "../../utils/download/transformGeometry.js";
import isInternetExplorer from "../../../../../utils/isInternetExplorer.js";
...
function setDownloadFeatures({ state, commit, dispatch, rootGetters }) {
    ...
    drawnFeatures?.forEach((drawnFeature) => {
        ...
        if (
            ...
            drawnFeature.get("styleId") ===
                state.selectedFeature.get("styleId") &&
    ...
    switch (type) {
        ...
        default:
            dispatch(
                ...
                i18next.t("common:modules.tools.download.unknownGeometry", {
                    geometry: type,
                }),
                { root: true }
            );
