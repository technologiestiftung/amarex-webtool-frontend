...
describe("src_3_0_0/core/js/layers/layer2d.js", () => {
  ...
  describe("autoRefresh", () => {
    let controlAutoRefreshSpy, startAutoRefreshSpy, stopAutoRefreshSpy, layer2d;

    beforeEach(() => {
      controlAutoRefreshSpy = sinon.spy(
        Layer2d.prototype,
        "controlAutoRefresh",
      );
  ...
  describe("errorHandling", () => {
    it("errorHandling shall dispatch Alerting with i18next key", function () {
      ...
      expect(alertMessage.content).to.be.equals(
        "core.layers.errorHandling.403",
      );
