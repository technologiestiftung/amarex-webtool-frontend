...
describe("src_3_0_0/core/js/layers/layer2dVectorSensorThings.js", () => {
  let attributes, errorStub, sensorThingsLayer, warnStub;
  ...
  beforeEach(() => {
    ...
    sinon
      .stub(
        Layer2dVectorSensorThings.prototype,
        "createMqttConnectionToSensorThings",
      )
      .callsFake(sinon.stub());
    sinon
      .stub(Layer2dVectorSensorThings.prototype, "callSensorThingsAPI")
      .callsFake(sinon.stub());
    sinon
      .stub(Layer2dVectorSensorThings.prototype, "initializeSensorThings")
      .callsFake(sinon.stub());
    attributes = {
      id: "id",
  ...
  describe("createLayer", () => {
    ...
    it("createLayer shall create an ol/VectorLayer with cluster-source", () => {
      ...
      expect(layer.getSource().getDistance()).to.be.equals(
        attributes.clusterDistance,
      );
      expect(typeof layer.getStyleFunction()).to.be.equals("function");
    });
  });
  ...
  describe("getRawLayerAttributes", () => {
    ...
    it("should return the raw layer attributes", () => {
      expect(
        sensorThingsLayer.getRawLayerAttributes(localAttributes),
      ).to.deep.equals({
        clusterDistance: 10,
        id: "1234",
        url: "exmpale.url",
  ...
  describe("getOptions", () => {
    ...
    beforeEach(() => {
      options = ["clusterGeometryFunction", "featuresFilter", "onLoadingError"];
    });

    it("should return the options that includes the correct keys", () => {
      expect(
        Object.keys(sensorThingsLayer.getOptions(attributes)),
      ).to.deep.equals(options);
    });
  });
  ...
  describe("getStyleFunction", () => {
    ...
    it("initStyle shall be called on creation and call createStyle if styleListLoaded=true", function () {
      const createStyleSpy = sinon.spy(
        Layer2dVectorSensorThings.prototype,
        "createStyle",
      );
  ...
  describe("getMqttHostFromUrl", () => {
    it("should call the error handler if anything but a string is given as first parameter and should return an empty string", () => {
      let lastError = null;
      const result = sensorThingsLayer.getMqttHostFromUrl(
        undefined,
        (error) => {
          lastError = error;
        },
  ...
  describe("getDatastreamIdFromMqttTopic", () => {
    it("should return an empty string if anything but a string is given", () => {
      expect(sensorThingsLayer.getDatastreamIdFromMqttTopic(undefined)).to.be.a(
        "string",
      ).and.to.be.empty;
      expect(sensorThingsLayer.getDatastreamIdFromMqttTopic(null)).to.be.a(
        "string",
      ).and.to.be.empty;
      expect(sensorThingsLayer.getDatastreamIdFromMqttTopic(1234)).to.be.a(
        "string",
      ).and.to.be.empty;
      expect(sensorThingsLayer.getDatastreamIdFromMqttTopic(true)).to.be.a(
        "string",
      ).and.to.be.empty;
      expect(sensorThingsLayer.getDatastreamIdFromMqttTopic(false)).to.be.a(
        "string",
      ).and.to.be.empty;
      expect(sensorThingsLayer.getDatastreamIdFromMqttTopic([])).to.be.a(
        "string",
      ).and.to.be.empty;
      expect(sensorThingsLayer.getDatastreamIdFromMqttTopic({})).to.be.a(
        "string",
    ...
    it("should return an empty string if a string without a certain indicator is given", () => {
      expect(sensorThingsLayer.getDatastreamIdFromMqttTopic("test")).to.be.a(
        "string",
      ).and.to.be.empty;
    });
    ...
    it("should return the first occurence of an id within certain indicators", () => {
      expect(
        sensorThingsLayer.getDatastreamIdFromMqttTopic(
          "test.Datastreams(1234).Observations(5678)",
        ),
      ).to.equal("1234");
    });
  });
  ...
  describe("getFeatureByDatastreamId", () => {
    it("should return null if the first parameter is anything but an array", () => {
      ...
      expect(sensorThingsLayer.getFeatureByDatastreamId(null, "6789")).to.be
        .null;
      expect(sensorThingsLayer.getFeatureByDatastreamId(undefined, "6789")).to
        .be.null;
      expect(sensorThingsLayer.getFeatureByDatastreamId(123, "6789")).to.be
        .null;
      expect(sensorThingsLayer.getFeatureByDatastreamId(true, "6789")).to.be
        .null;
      expect(sensorThingsLayer.getFeatureByDatastreamId(false, "6789")).to.be
        .null;
      expect(sensorThingsLayer.getFeatureByDatastreamId("string", "6789")).to.be
        .null;
    });
    ...
    it("should return null if the second parameter is anything but a string", () => {
      ...
      expect(sensorThingsLayer.getFeatureByDatastreamId([], undefined)).to.be
        .null;
    ...
    it("should return null if the given features are an empty array", () => {
      expect(sensorThingsLayer.getFeatureByDatastreamId([], "string")).to.be
        .null;
    });
    ...
    it("should return null if the given id is not included in any dataStreamId of the given features", () => {
      ...
      expect(sensorThingsLayer.getFeatureByDatastreamId(features, "4321")).to.be
        .null;
    });
    ...
    it("should return null if the given id is only a sub part of an id of a piped dataStreamId string", () => {
      ...
      expect(sensorThingsLayer.getFeatureByDatastreamId(features, "23")).to.be
        .null;
    });
  });
  ...
  describe("getDatastreamIdsHelper", () => {
    it("should return false if the first parameter is not an object", () => {
      ...
      expect(sensorThingsLayer.getDatastreamIdsHelper(undefined, [])).to.be
        .false;
      ...
      expect(sensorThingsLayer.getDatastreamIdsHelper("string", [])).to.be
        .false;
    });
    ...
    it("should return false if the first parameter has not string value under dataStreamId received by getter", () => {
      expect(
        sensorThingsLayer.getDatastreamIdsHelper({ get: () => undefined }, []),
      ).to.be.false;
      expect(sensorThingsLayer.getDatastreamIdsHelper({ get: () => null }, []))
        .to.be.false;
      expect(sensorThingsLayer.getDatastreamIdsHelper({ get: () => 123 }, []))
        .to.be.false;
      expect(sensorThingsLayer.getDatastreamIdsHelper({ get: () => true }, []))
        .to.be.false;
      expect(sensorThingsLayer.getDatastreamIdsHelper({ get: () => false }, []))
        .to.be.false;
      expect(sensorThingsLayer.getDatastreamIdsHelper({ get: () => [] }, [])).to
        .be.false;
      expect(
        sensorThingsLayer.getDatastreamIdsHelper(
          {
            get: () => {
              return {};
            },
    ...
    it("should return false if the second parameter is not an array", () => {
      ...
      expect(
        sensorThingsLayer.getDatastreamIdsHelper({ get: () => "string" }, null),
      ).to.be.false;
      expect(
        sensorThingsLayer.getDatastreamIdsHelper({ get: () => "string" }, 123),
      ).to.be.false;
      expect(
        sensorThingsLayer.getDatastreamIdsHelper({ get: () => "string" }, true),
      ).to.be.false;
      expect(
        sensorThingsLayer.getDatastreamIdsHelper(
          { get: () => "string" },
      ...
      expect(
        sensorThingsLayer.getDatastreamIdsHelper({ get: () => "string" }, {}),
      ).to.be.false;
      expect(
        sensorThingsLayer.getDatastreamIdsHelper(
          { get: () => "string" },
    ...
    it("should push a pipeless value into the second parameter", () => {
      ...
      expect(sensorThingsLayer.getDatastreamIdsHelper(feature, result)).to.be
        .true;
  ...
  describe("getDatastreamIds", () => {
    it("should return an empty array if the given parameter is not an array", () => {
      expect(sensorThingsLayer.getDatastreamIds(undefined)).to.be.an("array")
        .and.to.be.empty;
      expect(sensorThingsLayer.getDatastreamIds(null)).to.be.an("array").and.to
        .be.empty;
      expect(sensorThingsLayer.getDatastreamIds(123)).to.be.an("array").and.to
        .be.empty;
      expect(sensorThingsLayer.getDatastreamIds(true)).to.be.an("array").and.to
        .be.empty;
      expect(sensorThingsLayer.getDatastreamIds(false)).to.be.an("array").and.to
        .be.empty;
      expect(sensorThingsLayer.getDatastreamIds("string")).to.be.an("array").and
        .to.be.empty;
      expect(sensorThingsLayer.getDatastreamIds({})).to.be.an("array").and.to.be
        .empty;
    });
    ...
    it("should return an empty array if the features are not objects", () => {
      expect(
        sensorThingsLayer.getDatastreamIds([
          undefined,
          null,
          123,
          true,
    ...
    it("should return an empty array if the features are objects but have no get function", () => {
      expect(sensorThingsLayer.getDatastreamIds([{}, { get: false }])).to.be.an(
        "array",
      ).and.to.be.empty;
    });
    ...
    it("should collect the datastream ids of the features if the features have no sub features", () => {
      ...
      expect(sensorThingsLayer.getDatastreamIds(features)).to.deep.equal([
        "123",
        "456",
        "789",
      ]);
  ...
  describe("replaceValueInArrayByReference", () => {
    it("should return false if the given result is not an array", () => {
      expect(
        sensorThingsLayer.replaceValueInArrayByReference(
          undefined,
          [],
          "string",
          "value",
  ...
  describe("replaceValueInPipedProperty", () => {
    it("should return an empty string if the given parameters are not correct", () => {
      expect(
        sensorThingsLayer.replaceValueInPipedProperty(
          {},
          "dataStreamValue",
          "8805",
          "available",
  ...
  describe("updateFeatureProperties", () => {
    ...
    it("should return false if the given feature has not set function", () => {
      expect(sensorThingsLayer.updateFeatureProperties({ get: () => false })).to
        .be.false;
    });

    it("should return false if the feature has no dataStreamId property", () => {
      expect(
        sensorThingsLayer.updateFeatureProperties({
          get: () => false,
          set: () => false,
        }),
      ).to.be.false;
    ...
    it("should return false if the feature has no dataStreamName property", () => {
      expect(
        sensorThingsLayer.updateFeatureProperties({
          get: (key) => (key === "dataStreamId" ? "str" : false),
          set: () => false,
        }),
      ).to.be.false;
    });
  ...
  describe("enlargeExtent", () => {
    it("should return correctly enlarged extent", () => {
      expect(sensorThingsLayer.enlargeExtent([100, 100, 200, 200], 0.1))
        .to.be.an("array")
        .to.have.ordered.members([90, 90, 210, 210]);
    });
    it("should return correctly reduced extent", () => {
      expect(sensorThingsLayer.enlargeExtent([100, 100, 200, 200], -0.1))
        .to.be.an("array")
        .to.have.ordered.members([110, 110, 190, 190]);
    });
  });

  describe("enlargeExtentForMovableFeatures", () => {
    it("should return false if the given parameter is null", () => {
      expect(sensorThingsLayer.enlargeExtentForMovableFeatures(null)).to.be
        .false;
    });

    it("should return false if the given parameter is undefined", () => {
      expect(sensorThingsLayer.enlargeExtentForMovableFeatures(undefined)).to.be
        .false;
    });

    it("should return false if the given parameter is null", () => {
      expect(sensorThingsLayer.enlargeExtentForMovableFeatures(666)).to.be
        .false;
    });
    ...
    it("should return false if the given parameter is a boolean", () => {
      expect(sensorThingsLayer.enlargeExtentForMovableFeatures(false)).to.be
        .false;
    });
    ...
    it("should return false if the second passed parameter is null", () => {
      expect(
        sensorThingsLayer.enlargeExtentForMovableFeatures(
          [400, 400, 900, 900],
          null,
        ),
      ).to.be.false;
    ...
    it("should return correctly enlarged extent if third parameter is not a number", () => {
      expect(
        ...
        .to.be.an("array")
        .to.deep.equal([300, 300, 1000, 1000]);
    });
    ...
    it("should return correctly enlarged extent if all parameter are given", () => {
      expect(
        ...
        .to.be.an("array")
        .to.deep.equal([200, 200, 1100, 1100]);
    });
  });
  ...
  describe("getFeaturesInExtent", () => {
    it("should return no feature within extent", () => {
      ...
      expect(
        sensorThingsLayer.getFeaturesInExtent(features, currentExtent),
    ...
    it("should return only one feature within extent", () => {
      ...
      expect(sensorThingsLayer.getFeaturesInExtent(features, currentExtent))
        .to.be.an("array")
        .to.have.lengthOf(1);
    });
    ...
    it("should return all features inside enlarged extent by 'maxSpeedKmh'", () => {
      ...
      expect(sensorLayer.getFeaturesInExtent(features, currentExtent))
        .to.be.an("array")
        .to.have.lengthOf(2);
    });
  ...
  describe("getDatastreamIds", () => {
    it("should return a empty array for undefined input", () => {
      expect(sensorThingsLayer.getDatastreamIds(undefined)).to.be.an("array")
        .that.is.empty;
      expect(sensorThingsLayer.getDatastreamIds(null)).to.be.an("array").that.is
        .empty;
      expect(sensorThingsLayer.getDatastreamIds({})).to.be.an("array").that.is
        .empty;
      expect(sensorThingsLayer.getDatastreamIds(123)).to.be.an("array").that.is
        .empty;
      expect(sensorThingsLayer.getDatastreamIds("string")).to.be.an("array")
        .that.is.empty;
      expect(sensorThingsLayer.getDatastreamIds(true)).to.be.an("array").that.is
        .empty;
      expect(sensorThingsLayer.getDatastreamIds(false)).to.be.an("array").that
        .is.empty;
    });
    ...
    it("should return an array with Strings for features input", () => {
      ...
      expect(sensorThingsLayer.getDatastreamIds(features))
        .to.be.an("array")
        .that.includes("1", "2", "3", "4");
    });
  });

  describe("getFeatureByDatastreamId", () => {
    it("should return null on undefined inputs", () => {
      expect(sensorThingsLayer.getFeatureByDatastreamId(undefined, undefined))
        .to.be.null;
    });

    it("should return null on undefined array", () => {
      expect(sensorThingsLayer.getFeatureByDatastreamId(undefined, "1")).to.be
        .null;
    });
    ...
    it("should return a Feature", () => {
      ...
      expect(
        sensorThingsLayer.getFeatureByDatastreamId(features, "1"),
    ...
    it("should return a Feature with combined dataStreamId", () => {
      ...
      expect(
        sensorThingsLayer.getFeatureByDatastreamId(features, "3"),
      ).to.be.an.instanceof(Feature);
    });
  });
  ...
  describe("aggregatePropertiesOfThings", () => {
    it("should set one Thing in a simple way without aggregation", () => {
      ...
      expect(
        sensorThingsLayer.aggregatePropertiesOfThings(
          allThings,
          "http://example.com",
          "1.1",
        ),
      ).to.deep.equal(expectedOutcome);
    });
  ...
  describe("getThingsGeometry", () => {
    it("should return the location in geometry", () => {
      ...
      expect(sensorThingsLayer.getThingsGeometry(testObject, 0))
        .to.be.an("object")
        .to.include({ test: "Test" });
    ...
    it("should return the location without geometry", () => {
      ...
      expect(sensorThingsLayer.getThingsGeometry(testObject2, 0))
        .to.be.an("object")
        .to.include({ test: "Test" });
  ...
  describe("buildSensorThingsUrl", () => {
    it("should return an url as string for a specific input", () => {
      const testUrl = "https://www.example.com:1234/foo/bar",
        ...
        expectedOutput =
          "https://www.example.com:1234/foo/bar/v1.1/Things?$baz=1234&$qux=foobar";

      expect(
        sensorThingsLayer.buildSensorThingsUrl(
          testUrl,
          testVersion,
          testUrlParams,
        ),
    ...
    it("should return an url with datastreams as root", () => {
      const testUrl = "https://www.example.com:1234/foo/bar",
        ...
        expectedOutput =
          "https://www.example.com:1234/foo/bar/v1.1/Datastreams?$filter=fi&$expand=ex";
    ...
    it("should return an url as string for a specific input including nested urlParams", () => {
      const testUrl = "https://www.example.com:1234/foo/bar",
        ...
        testUrlParams = {
          baz: 1234,
          qux: ["subParamA", "subParamB", "subParamC"],
        },
        expectedOutput =
          "https://www.example.com:1234/foo/bar/v1.1/Things?$baz=1234&$qux=subParamA,subParamB,subParamC";
    ...
    it("should return an url without query if no params as object are given", () => {
      ...
      expect(
        sensorThingsLayer.buildSensorThingsUrl(testUrl, testVersion, false),
      ).to.equal(expectedOutput);
      expect(
        sensorThingsLayer.buildSensorThingsUrl(testUrl, testVersion, undefined),
      ).to.equal(expectedOutput);
      expect(
        sensorThingsLayer.buildSensorThingsUrl(testUrl, testVersion, null),
      ).to.equal(expectedOutput);
      expect(
        sensorThingsLayer.buildSensorThingsUrl(testUrl, testVersion, "baz"),
      ).to.equal(expectedOutput);
      expect(
        sensorThingsLayer.buildSensorThingsUrl(testUrl, testVersion, 12345),
      ).to.equal(expectedOutput);
      expect(
        sensorThingsLayer.buildSensorThingsUrl(testUrl, testVersion, []),
      ).to.equal(expectedOutput);
      expect(
        sensorThingsLayer.buildSensorThingsUrl(testUrl, testVersion, {}),
      ).to.equal(expectedOutput);
    ...
    it("should eat any url possible without checking its target or syntax", () => {
      ...
      expect(
        sensorThingsLayer.buildSensorThingsUrl("", "1.1", testUrlParams),
      ).to.equal("/v1.1/Things?$foo=bar");
      expect(
        sensorThingsLayer.buildSensorThingsUrl("http://", "1.1", testUrlParams),
      ).to.equal("http:///v1.1/Things?$foo=bar");
      expect(
        sensorThingsLayer.buildSensorThingsUrl(
          "wfs://baz",
          "1.1",
      ...
      ).to.equal("wfs://baz/v1.1/Things?$foo=bar");
      expect(
        sensorThingsLayer.buildSensorThingsUrl(
          "foobar://baz////",
          "1.1",
      ...
      ).to.equal("foobar://baz/////v1.1/Things?$foo=bar");
    });

    it("should take any version as string unchecked", () => {
      expect(sensorThingsLayer.buildSensorThingsUrl("", "1.1", false)).to.equal(
        "/v1.1/Things?",
      );
      expect(sensorThingsLayer.buildSensorThingsUrl("", "foo", false)).to.equal(
        "/vfoo/Things?",
      );
      expect(
        sensorThingsLayer.buildSensorThingsUrl("", "foo.bar.baz", false),
      ).to.equal("/vfoo.bar.baz/Things?");
    });

    it("should take any version as number fixed to one decimal number", () => {
      expect(sensorThingsLayer.buildSensorThingsUrl("", 0.5, false)).to.equal(
        "/v0.5/Things?",
      );
      expect(sensorThingsLayer.buildSensorThingsUrl("", 0.55, false)).to.equal(
        "/v0.6/Things?",
      );
      expect(
        sensorThingsLayer.buildSensorThingsUrl("", 0.00000001, false),
      ).to.equal("/v0.0/Things?");
      expect(
        sensorThingsLayer.buildSensorThingsUrl("", 999999.9999999, false),
      ).to.equal("/v1000000.0/Things?");
    });
    ...
    it("should stringify any given parameter for url and version - no matter what", () => {
      ...
      ).to.equal("undefined/vundefined/Things?$foo=bar");
      expect(
        sensorThingsLayer.buildSensorThingsUrl(null, null, testUrlParams),
      ).to.equal("null/vnull/Things?$foo=bar");
      expect(
        sensorThingsLayer.buildSensorThingsUrl([], [], testUrlParams),
      ).to.equal("/v/Things?$foo=bar");
      expect(
        sensorThingsLayer.buildSensorThingsUrl({}, {}, testUrlParams),
      ).to.equal("[object Object]/v[object Object]/Things?$foo=bar");
    });
  });
  ...
  describe("createPropertiesOfDatastreamsHelper", () => {
    it("should return false if the first parameter is not an array", () => {
      expect(sensorThingsLayer.createPropertiesOfDatastreamsHelper(undefined))
        .to.be.false;
      expect(sensorThingsLayer.createPropertiesOfDatastreamsHelper(null)).to.be
        .false;
      expect(sensorThingsLayer.createPropertiesOfDatastreamsHelper(123)).to.be
        .false;
      expect(sensorThingsLayer.createPropertiesOfDatastreamsHelper("string")).to
        .be.false;
      expect(sensorThingsLayer.createPropertiesOfDatastreamsHelper(true)).to.be
        .false;
      expect(sensorThingsLayer.createPropertiesOfDatastreamsHelper(false)).to.be
        .false;
      expect(sensorThingsLayer.createPropertiesOfDatastreamsHelper({})).to.be
        .false;
    });

    it("should return false if the second parameter is not an object", () => {
      expect(
        sensorThingsLayer.createPropertiesOfDatastreamsHelper([], undefined),
      ).to.be.false;
      expect(sensorThingsLayer.createPropertiesOfDatastreamsHelper([], null)).to
        .be.false;
      expect(sensorThingsLayer.createPropertiesOfDatastreamsHelper([], 123)).to
        .be.false;
      expect(
        sensorThingsLayer.createPropertiesOfDatastreamsHelper([], "string"),
      ).to.be.false;
      expect(sensorThingsLayer.createPropertiesOfDatastreamsHelper([], true)).to
        .be.false;
      expect(sensorThingsLayer.createPropertiesOfDatastreamsHelper([], false))
        .to.be.false;
      expect(sensorThingsLayer.createPropertiesOfDatastreamsHelper([], [])).to
        .be.false;
    });
    ...
    it("should return true if the first parameter is an array, should not alter the second parameter", () => {
      ...
      expect(
        sensorThingsLayer.createPropertiesOfDatastreamsHelper(
          [undefined, null, 123, "string", true, false, []],
          properties,
        ),
      ).to.be.true;
  ...
  describe("createPropertiesOfDatastreams", () => {
    it("should return an empty array if the first parameter is not an array", () => {
      expect(
        sensorThingsLayer.createPropertiesOfDatastreams(undefined),
      ).to.be.an("array").and.to.be.empty;
      expect(sensorThingsLayer.createPropertiesOfDatastreams(null)).to.be.an(
        "array",
      ).and.to.be.empty;
      expect(sensorThingsLayer.createPropertiesOfDatastreams(123)).to.be.an(
        "array",
      ).and.to.be.empty;
      expect(
        sensorThingsLayer.createPropertiesOfDatastreams("string"),
      ).to.be.an("array").and.to.be.empty;
      expect(sensorThingsLayer.createPropertiesOfDatastreams(true)).to.be.an(
        "array",
      ).and.to.be.empty;
      expect(sensorThingsLayer.createPropertiesOfDatastreams(false)).to.be.an(
        "array",
      ).and.to.be.empty;
      expect(sensorThingsLayer.createPropertiesOfDatastreams({})).to.be.an(
        "array",
      ).and.to.be.empty;
    });
    ...
    it("should return the first parameter untouched if its content are no objects", () => {
      ...
      expect(
        sensorThingsLayer.createPropertiesOfDatastreams(allThings),
  ...
  describe("moveDatastreamPropertiesToThing", () => {
    it("should return false if the first parameter is not an object", () => {
      expect(sensorThingsLayer.moveDatastreamPropertiesToThing(undefined)).to.be
        .false;
      expect(sensorThingsLayer.moveDatastreamPropertiesToThing(null)).to.be
        .false;
      expect(sensorThingsLayer.moveDatastreamPropertiesToThing(123)).to.be
        .false;
      expect(sensorThingsLayer.moveDatastreamPropertiesToThing("string")).to.be
        .false;
      expect(sensorThingsLayer.moveDatastreamPropertiesToThing(true)).to.be
        .false;
      expect(sensorThingsLayer.moveDatastreamPropertiesToThing(false)).to.be
        .false;
      expect(sensorThingsLayer.moveDatastreamPropertiesToThing([])).to.be.false;
    });

    it("should return false if the second parameter is not an object", () => {
      expect(sensorThingsLayer.moveDatastreamPropertiesToThing({}, undefined))
        .to.be.false;
      expect(sensorThingsLayer.moveDatastreamPropertiesToThing({}, null)).to.be
        .false;
      expect(sensorThingsLayer.moveDatastreamPropertiesToThing({}, 123)).to.be
        .false;
      expect(sensorThingsLayer.moveDatastreamPropertiesToThing({}, "string")).to
        .be.false;
      expect(sensorThingsLayer.moveDatastreamPropertiesToThing({}, true)).to.be
        .false;
      expect(sensorThingsLayer.moveDatastreamPropertiesToThing({}, false)).to.be
        .false;
      expect(sensorThingsLayer.moveDatastreamPropertiesToThing({}, [])).to.be
        .false;
    });
    ...
    it("should create thingProperties equal to dataStreamProperties if thingProperties are an empty object", () => {
      ...
      expect(
        sensorThingsLayer.moveDatastreamPropertiesToThing(
          thingProperties,
          dataStreamProperties,
        ),
      ).to.be.true;
  ...
  describe("createAssociationObject", () => {
    it("should return an empty object if anything but an array is given", () => {
      expect(sensorThingsLayer.createAssociationObject(undefined)).to.be.an(
        "object",
      ).and.to.be.empty;
      expect(sensorThingsLayer.createAssociationObject(null)).to.be.an("object")
        .and.to.be.empty;
      expect(sensorThingsLayer.createAssociationObject(123)).to.be.an("object")
        .and.to.be.empty;
      expect(sensorThingsLayer.createAssociationObject("string")).to.be.an(
        "object",
      ).and.to.be.empty;
      expect(sensorThingsLayer.createAssociationObject(true)).to.be.an("object")
        .and.to.be.empty;
      expect(sensorThingsLayer.createAssociationObject(false)).to.be.an(
        "object",
      ).and.to.be.empty;
      expect(sensorThingsLayer.createAssociationObject({})).to.be.an("object")
        .and.to.be.empty;
    });
  ...
  describe("changeSensordataRootToThings", () => {
    it("should return an empty array if the first parameter is anything but an array", () => {
      expect(
        sensorThingsLayer.changeSensordataRootToThings(undefined),
      ).to.be.an("array").and.to.be.empty;
      expect(sensorThingsLayer.changeSensordataRootToThings(null)).to.be.an(
        "array",
      ).and.to.be.empty;
      expect(sensorThingsLayer.changeSensordataRootToThings(123)).to.be.an(
        "array",
      ).and.to.be.empty;
      expect(sensorThingsLayer.changeSensordataRootToThings("string")).to.be.an(
        "array",
      ).and.to.be.empty;
      expect(sensorThingsLayer.changeSensordataRootToThings(true)).to.be.an(
        "array",
      ).and.to.be.empty;
      expect(sensorThingsLayer.changeSensordataRootToThings(false)).to.be.an(
        "array",
      ).and.to.be.empty;
      expect(sensorThingsLayer.changeSensordataRootToThings({})).to.be.an(
        "array",
      ).and.to.be.empty;
    });
    ...
    it("should return an empty array if the first parameter is an array without objects", () => {
      expect(
        sensorThingsLayer.changeSensordataRootToThings([
          undefined,
          null,
          123,
          "string",
  ...
  describe("getLocalTimeFormat", () => {
    it("should return an empty for undefined input", () => {
      expect(
        sensorThingsLayer.getLocalTimeFormat(undefined, undefined),
      ).to.be.a("string").and.to.be.empty;
    });

    it("should return an empty  string for undefined phenomenontime and utc +1", () => {
      expect(
        sensorThingsLayer.getLocalTimeFormat(undefined, "Europe/Berlin"),
      ).to.be.a("string").and.to.be.empty;
    });
    ...
    it("should return a string in summertime", () => {
      ...
      expect(
        sensorThingsLayer.getLocalTimeFormat(summerTime, "Europe/Berlin"),
      ).to.equal("5. Juni 2018 14:11");
    });
    ...
    it("should return a string in wintertime", () => {
      ...
      expect(
        sensorThingsLayer.getLocalTimeFormat(winterTime, "Europe/Berlin"),
      ).to.equal("1. Januar 2018 13:11");
    });
  });

  describe("getFirstPhenomenonTime", () => {
    it("should return undefined if anything but a string is given", () => {
      expect(sensorThingsLayer.getFirstPhenomenonTime(undefined)).to.be
        .undefined;
    ...
    it("should return the input as it is if a single phenomenon time is recognized", () => {
      expect(
        sensorThingsLayer.getFirstPhenomenonTime("2020-04-02T14:00:01.100Z"),
      ).to.equal("2020-04-02T14:00:01.100Z");
    });

    it("should return first time if phenomenon time interval is given", () => {
      expect(
        sensorThingsLayer.getFirstPhenomenonTime(
          "2020-04-02T14:00:01.100Z/2020-04-02T14:15:00.000Z",
        ),
      ).to.equal("2020-04-02T14:00:01.100Z");
    });
  });
  ...
  describe("aggregateDataStreamPhenomenonTime", () => {
    it("should return undefined for undefined input", () => {
      expect(sensorThingsLayer.aggregateDataStreamPhenomenonTime(undefined)).to
        .be.undefined;
    });
    ...
    it("should return feature as is", () => {
      ...
      expect(
        sensorThingsLayer.aggregateDataStreamPhenomenonTime(feature),
      ).to.be.instanceof(Feature);
    });
    ...
    it("should return feature with dataStreamPhenomenonTime for one dataStream", () => {
      ...
      expect(
        sensorThingsLayer
          .aggregateDataStreamPhenomenonTime(feature)
          .get("dataStreamPhenomenonTime"),
      ).to.equal("a");
    });
  ...
  describe("aggregateDataStreamValue", () => {
    it("should return undefined for undefined input", () => {
      expect(sensorThingsLayer.aggregateDataStreamValue(undefined)).to.be
        .undefined;
    });
    ...
    it("should return feature as is", () => {
      ...
      expect(
        sensorThingsLayer.aggregateDataStreamValue(feature),
      ).to.be.instanceof(Feature);
    });
    ...
    it("should return feature with dataStreamValue for one dataStream", () => {
      ...
      expect(
        sensorThingsLayer
          .aggregateDataStreamValue(feature)
          .get("dataStreamValue"),
      ).to.equal("a");
    });
  ...
  describe("aggregatePropertiesOfOneThing", () => {
    it("should return false if the first parameter is not an object", () => {
      expect(sensorThingsLayer.aggregatePropertiesOfOneThing(undefined)).to.be
        .false;
      ...
      expect(sensorThingsLayer.aggregatePropertiesOfOneThing("string")).to.be
        .false;
      expect(sensorThingsLayer.aggregatePropertiesOfOneThing(true)).to.be.false;
      expect(sensorThingsLayer.aggregatePropertiesOfOneThing(false)).to.be
        .false;
      expect(sensorThingsLayer.aggregatePropertiesOfOneThing([])).to.be.false;
    });

    it("should return false if the second parameter is not an object", () => {
      expect(sensorThingsLayer.aggregatePropertiesOfOneThing({}, undefined)).to
        .be.false;
      expect(sensorThingsLayer.aggregatePropertiesOfOneThing({}, null)).to.be
        .false;
      expect(sensorThingsLayer.aggregatePropertiesOfOneThing({}, 123)).to.be
        .false;
      expect(sensorThingsLayer.aggregatePropertiesOfOneThing({}, "string")).to
        .be.false;
      expect(sensorThingsLayer.aggregatePropertiesOfOneThing({}, true)).to.be
        .false;
      expect(sensorThingsLayer.aggregatePropertiesOfOneThing({}, false)).to.be
        .false;
      expect(sensorThingsLayer.aggregatePropertiesOfOneThing({}, [])).to.be
        .false;
    });
  ...
  describe("aggregatePropertiesOfThingAsArray", () => {
    it("should return false if the given array of things is not an array", () => {
      expect(sensorThingsLayer.aggregatePropertiesOfThingAsArray(undefined)).to
        .be.false;
      expect(sensorThingsLayer.aggregatePropertiesOfThingAsArray(null)).to.be
        .false;
      expect(sensorThingsLayer.aggregatePropertiesOfThingAsArray(123)).to.be
        .false;
      expect(sensorThingsLayer.aggregatePropertiesOfThingAsArray("string")).to
        .be.false;
      expect(sensorThingsLayer.aggregatePropertiesOfThingAsArray(true)).to.be
        .false;
      expect(sensorThingsLayer.aggregatePropertiesOfThingAsArray(false)).to.be
        .false;
      expect(sensorThingsLayer.aggregatePropertiesOfThingAsArray({})).to.be
        .false;
    });

    it("should return false if the given result is not an object", () => {
      expect(sensorThingsLayer.aggregatePropertiesOfThingAsArray([], undefined))
        .to.be.false;
      expect(sensorThingsLayer.aggregatePropertiesOfThingAsArray([], null)).to
        .be.false;
      expect(sensorThingsLayer.aggregatePropertiesOfThingAsArray([], 123)).to.be
        .false;
      expect(sensorThingsLayer.aggregatePropertiesOfThingAsArray([], "string"))
        .to.be.false;
      expect(sensorThingsLayer.aggregatePropertiesOfThingAsArray([], true)).to
        .be.false;
      expect(sensorThingsLayer.aggregatePropertiesOfThingAsArray([], false)).to
        .be.false;
      expect(sensorThingsLayer.aggregatePropertiesOfThingAsArray([], [])).to.be
        .false;
    });
  ...
  describe("flattenArray", () => {
    it("should return the given input if it is not an array", () => {
      ...
      expect(sensorThingsLayer.flattenArray({ id: "123" })).to.deep.equal({
        id: "123",
      });
    });
    ...
    it("should return flattened array for two dimentional arrays", () => {
      expect(
        sensorThingsLayer.flattenArray([["1", "2"], ["3"], ["4"]]),
    ...
    it("should return a flattened array for a given complex structure", () => {
      expect(
        sensorThingsLayer.flattenArray([
          undefined,
          ["1", "2"],
          [null],
          ["3"],
  ...
  describe("getStateOfSTALayer", () => {
    ...
    it("should return undefined if certain params are given", () => {
      ...
      expect(sensorThingsLayer.getStateOfSTALayer(false, false)).to.be
        .undefined;
    });
  });
  ...
  describe("subscribeToSensorThings", () => {
    it("should return false if datastreamIds is not an array", async () => {
      expect(await sensorThingsLayer.subscribeToSensorThings(undefined)).to.be
        .false;
      ...
      expect(await sensorThingsLayer.subscribeToSensorThings("string")).to.be
        .false;
      expect(await sensorThingsLayer.subscribeToSensorThings(true)).to.be.false;
      expect(await sensorThingsLayer.subscribeToSensorThings(false)).to.be
        .false;
    ...
    it("should return false if subscriptionTopics is not an object", async () => {
      expect(await sensorThingsLayer.subscribeToSensorThings([], undefined)).to
        .be.false;
      expect(await sensorThingsLayer.subscribeToSensorThings([], null)).to.be
        .false;
      expect(await sensorThingsLayer.subscribeToSensorThings([], 123)).to.be
        .false;
      expect(await sensorThingsLayer.subscribeToSensorThings([], "string")).to
        .be.false;
      expect(await sensorThingsLayer.subscribeToSensorThings([], true)).to.be
        .false;
      expect(await sensorThingsLayer.subscribeToSensorThings([], false)).to.be
        .false;
      expect(await sensorThingsLayer.subscribeToSensorThings([], [])).to.be
        .false;
    });

    it("should return false if mqttClient is not an object", async () => {
      expect(
        await sensorThingsLayer.subscribeToSensorThings(
          [],
          {},
          "version",
          undefined,
      ...
      expect(
        await sensorThingsLayer.subscribeToSensorThings([], {}, "version", 123),
      ).to.be.false;
      expect(
        await sensorThingsLayer.subscribeToSensorThings(
          [],
      ...
      expect(
        await sensorThingsLayer.subscribeToSensorThings([], {}, "version", []),
      ).to.be.false;
    });
    ...
    it("should return true, subscribe with expected topics and set subscription topics to true", async () => {
      ...
      expect(subscriptionTopics).to.deep.equal({
        1: true,
        2: true,
        4: true,
        3: true,
  ...
  describe("unsubscribeFromSensorThings", () => {
    it("should return false if datastreamIds is not an array", () => {
      expect(sensorThingsLayer.unsubscribeFromSensorThings(undefined)).to.be
        .false;
      ...
      expect(sensorThingsLayer.unsubscribeFromSensorThings("string")).to.be
        .false;
    ...
    it("should return false if subscriptionTopics is not an object", () => {
      expect(sensorThingsLayer.unsubscribeFromSensorThings([], undefined)).to.be
        .false;
      expect(sensorThingsLayer.unsubscribeFromSensorThings([], null)).to.be
        .false;
      expect(sensorThingsLayer.unsubscribeFromSensorThings([], 123)).to.be
        .false;
      expect(sensorThingsLayer.unsubscribeFromSensorThings([], "string")).to.be
        .false;
      expect(sensorThingsLayer.unsubscribeFromSensorThings([], true)).to.be
        .false;
      expect(sensorThingsLayer.unsubscribeFromSensorThings([], false)).to.be
        .false;
      expect(sensorThingsLayer.unsubscribeFromSensorThings([], [])).to.be.false;
    });
    ...
    it("should return false if mqttClient is not an object", () => {
      expect(
        sensorThingsLayer.unsubscribeFromSensorThings(
          [],
          {},
          "version",
          "isSelected",
    ...
    it("should return true, unsubscribe with expected topics and set subscription topics to false with advanced input", () => {
      ...
      expect(topicLogger).to.deep.equal(["v1.0/Datastreams(4)/Observations"]);
  ...
  describe("createFeaturesFromSensorData", () => {
    it("should return an empty array for any input that is not an array", () => {
      expect(
        sensorThingsLayer.createFeaturesFromSensorData(undefined),
      ).to.be.an("array").that.is.empty;
      expect(sensorThingsLayer.createFeaturesFromSensorData(null)).to.be.an(
        "array",
      ).that.is.empty;
      expect(sensorThingsLayer.createFeaturesFromSensorData(123)).to.be.an(
        "array",
      ).that.is.empty;
      expect(sensorThingsLayer.createFeaturesFromSensorData("string")).to.be.an(
        "array",
      ).that.is.empty;
      expect(sensorThingsLayer.createFeaturesFromSensorData(true)).to.be.an(
        "array",
      ).that.is.empty;
      expect(sensorThingsLayer.createFeaturesFromSensorData(false)).to.be.an(
        "array",
      ).that.is.empty;
      expect(sensorThingsLayer.createFeaturesFromSensorData({})).to.be.an(
        "array",
      ).that.is.empty;
    });
    ...
    it("should return an empty array for obj and undefined epsg input", () => {
      ...
      expect(
        sensorThingsLayer.createFeaturesFromSensorData(
          data,
          "mapProjection",
          undefined,
          "gfiTheme",
  ...
  describe("fetchHistoricalLocations", () => {
    it("should do nothing if first parameter is not a string", () => {
      const buildSensorThingsUrlStub = sinon.stub(
        sensorThingsLayer,
  ...
  describe("getHistoricalLocationsOfFeatures", () => {
    it("should do nothing", () => {
      const fetchHistoricalLocationsStub = sinon.stub(
        sensorThingsLayer,
      ...
      sinon
        .stub(sensorThingsLayer, "getDatastreamIdsInCurrentExtent")
        .returns([]);
  ...
  describe("parseSensorDataToFeature", () => {
    it("should not set historicalFeatures if given feature has no get function", () => {
      const addFeatureStub = sinon.stub(
          sensorThingsLayer.getLayerSource(),
          "addFeatures",
        ),
        feature = {
          getId: () => 0,
      ...
      sinon
        .stub(sensorThingsLayer, "createFeaturesFromSensorData")
        .returns([feature]);
  ...
  describe("updateFeatureLocation", () => {
    const feature = new Feature({
        geometry: new Point([10.086822509765625, 53.55825752009741]),
      }),
      observation = {
        location: { geometry: { coordinates: [566625.84, 5928050.84] } },
      };
    ...
    it("should update the coordinates", () => {
      ...
      expect(feature.getGeometry().getCoordinates()).to.deep.equal([
        -400603.08723813354, -7845263.190976434,
      ]);
    });
  });
  ...
  describe("updateHistoricalFeatures", () => {
    ...
    it("should call all expected functions", () => {
      ...
      sensorThingsLayer.updateHistoricalFeatures(
        feature,
        feature,
        sensorThingsLayer.getLayerSource(),
      );
  ...
  describe("getHistoricalLocationsOfFeatures", () => {
    it("should do nothing", () => {
      const fetchHistoricalLocationsByDatastreamIdStub = sinon.stub(
        sensorThingsLayer,
        "fetchHistoricalLocationsByDatastreamId",
      );
  ...
  describe("fetchHistoricalLocationsByDatastreamId", () => {
    it("should do nothing if first param is no array", () => {
      const getFeatureByDatastreamIdStub = sinon.stub(
        sensorThingsLayer,
        "getFeatureByDatastreamId",
      );
    ...
    it("should call fetchHistoricalLocations", () => {
      const getFeatureByDatastreamIdStub = sinon.stub(
        ...
        fetchHistoricalLocationsStub = sinon.stub(
          sensorThingsLayer,
          "fetchHistoricalLocations",
        );
  ...
  describe("getScale", () => {
    ...
    it("should returns the correct scale by the give zoomLevel and zoomLevelCount", () => {
      ...
      expect(
        sensorLayer.getScale(0, 4, true, zoomLevel, zoomLevelCount).toFixed(2),
      ).to.be.equal("0.30");
    });
  });
  ...
  describe("setDynamicalScaleOfHistoricalFeatures", () => {
    it("should not change the scale of feature", () => {
      ...
      sensorLayer.setDynamicalScaleOfHistoricalFeatures(
        [feature],
        undefined,
        10,
        true,
  ...
  describe("createLegend", () => {
    ...
    it("createLegend with legendURL", async () => {
      ...
      expect(await layerWrapper.createLegend()).to.be.deep.equals([
    ...
    it("createLegend with styleObject and legend true", async () => {
      ...
      sinon
        .stub(createStyle, "returnLegendByStyleId")
        .returns({ legendInformation });
