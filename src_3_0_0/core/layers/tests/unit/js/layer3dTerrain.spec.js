...
describe("src_3_0_0/core/js/layers/layer3dTerrain.js", () => {
  ...
  beforeEach(() => {
    ...
    global.Cesium.EllipsoidTerrainProvider = () => {
      /* no content*/
    };
    global.Cesium.CesiumTerrainProvider.fromUrl = () => sinon.stub();

    cesiumEllipsoidTerrainProviderSpy = sinon.spy(
      global.Cesium,
      "EllipsoidTerrainProvider",
    );
    cesiumTerrainProviderSpy = sinon.spy(
      global.Cesium,
  ...
  describe("createLayer", () => {
    ...
    it("createLayer shall create a visible terrain layer", () => {
      ...
      expect(fromUrlSpy.calledWithMatch("https://example.com", {})).to.equal(
        true,
      );
