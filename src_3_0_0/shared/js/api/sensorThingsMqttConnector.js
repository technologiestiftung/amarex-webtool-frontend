...
export class SensorThingsMqttConnector {
  ...
  on(eventName, handler, onerror) {
    if (typeof this.mqttClient?.on !== "function") {
      if (typeof onerror === "function") {
        onerror(
          "sensorThingsMqtt.js, on: the mqttClient is not ready to react to events. Set mqttClient and connect before adding events.",
        );
      }
      return;
      ...
      if (typeof onerror === "function") {
        onerror(
          "sensorThingsMqtt.js, on: the given event handler must be a function",
        );
      }
      return;
      ...
      if (typeof onerror === "function") {
        onerror(
          "sensorThingsMqtt.js, on(disconnect): this event is only supported for mqtt 5.0 or higher",
        );
      }
      return;
    }
  ...
  async subscribe(topic, options, onsuccess, onerror) {
    if (typeof this.mqttClient?.subscribe !== "function") {
      if (typeof onerror === "function") {
        onerror(
          "sensorThingsMqtt.js, subscribe: the mqttClient is not ready to subscribe. Set mqttClient and connect before adding subscriptions.",
        );
      }
      return;
    }
  ...
  unsubscribe(topic, options, onsuccess, onerror) {
    if (typeof this.mqttClient?.unsubscribe !== "function") {
      if (typeof onerror === "function") {
        onerror(
          "sensorThingsMqtt.js, unsubscribe: the mqttClient is not ready to unsubscribe. Set mqttClient and connect before unsubscribe.",
        );
      }
      return;
    }
   ...
   */
    ...
    if (typeof this.mqttClient?.end !== "function") {
      if (typeof onerror === "function") {
        onerror(
          "sensorThingsMqtt.js, end: the mqttClient is not ready to end. Set mqttClient and connect before ending the connection.",
        );
      }
      return;
    }
  ...
  simulateRetainedHandling(rhPath, topic, messageHandlers, onerror) {
    if (!Array.isArray(messageHandlers) || !messageHandlers.length) {
      ...
      if (typeof onerror === "function") {
        onerror(
          "sensorThingsMqtt.js, simulateRetainedHandling: to siumlate retained messages a httpClient must be set.",
        );
      }
      return;
      ...
      if (typeof onerror === "function") {
        onerror(
          "sensorThingsMqtt.js, simulateRetainedHandling: To use simulateRetainedHandling the rhPath must be given with the options.",
        );
      }
      return;
      ...
      if (typeof onerror === "function") {
        onerror(
          "sensorThingsMqtt.js, simulateRetainedHandling: A retained message can't be simulated without a topic.",
        );
      }
      return;
    }

    const lastTerm = topic
      .substring(topic.lastIndexOf("/"))
      .toLocaleLowerCase();
