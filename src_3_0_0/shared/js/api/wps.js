...
export default {
  ...
  buildXML: function (
    ...
    let dataString = this.setXMLElement(
      xmlTemplate,
      "</ows:Identifier>",
      identifier,
    );
    ...
    Object.entries(data).forEach((dat) => {
      const obj = dat[1],
        key = dat[0],
        dataType = Object.prototype.hasOwnProperty.call(obj, "dataType")
          ? obj.dataType
          : undefined,
      ...
      attributeString = this.setXMLElement(
        dataInputXmlTemplate,
        "</ows:Identifier>",
        key,
      );
  ...
  setXMLElement: function (dataString, closingTagName, value, dataType) {
    ...
    if (dataType !== undefined) {
      newDataString = newDataString
        ...
        .replace(
          "<wps:LiteralData>",
          "<wps:LiteralData dataType='" + dataType + "'>",
        );
    }
    ...
    if (
      ...
      newDataString = newDataString
        .toString()
        .replace(
          closingTagName.toString(),
          value.toString() + closingTagName.toString(),
        );
    }
