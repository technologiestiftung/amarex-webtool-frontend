...
describe("src_3_0_0/api/wfs/js", () => {
  describe("getFeatureGET", () => {
    ...
    it("should throw an error if the second parameter is an object without featureType as string or array", () => {
      expect(() =>
        getFeatureGET("url", { version: "version", featureType: undefined }),
      ).to.throw();
      expect(() =>
        getFeatureGET("url", { version: "version", featureType: null }),
      ).to.throw();
      expect(() =>
        getFeatureGET("url", { version: "version", featureType: 1234 }),
      ).to.throw();
      expect(() =>
        getFeatureGET("url", { version: "version", featureType: true }),
      ).to.throw();
      expect(() =>
        getFeatureGET("url", { version: "version", featureType: false }),
      ).to.throw();
      expect(() =>
        getFeatureGET("url", { version: "version", featureType: {} }),
      ).to.throw();
    });
    it("should not throw an error but stick it to the third parameter if third parameter is a function", () => {
      ...
      expect(() =>
        getFeatureGET(undefined, undefined, (error) => {
          lastError = error;
        }),
      ).to.not.throw();
  ...
  describe("getFeaturePOST", () => {
    ...
    it("should throw an error if the second parameter is an object without featureType as string or array", () => {
      expect(() =>
        getFeaturePOST("url", { featureTypes: undefined }),
      ).to.throw();
    ...
    it("should not throw an error but stick it to the third parameter if third parameter is a function", () => {
      ...
      expect(() =>
        getFeaturePOST(undefined, undefined, (error) => {
          lastError = error;
        }),
      ).to.not.throw();
      expect(lastError).to.be.an.instanceOf(Error);
