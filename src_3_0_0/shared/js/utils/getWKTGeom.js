...
function getWKTGeom(content, geometryType = "POLYGON") {
  const format = new WKT(),
    type = content?.geometryType
      ? content.geometryType.toUpperCase()
      : geometryType, // the default value is POLYGON because for type street, there is no geometryType defined. But it should be polygon
