...
describe("src_3_0_0/shared/js/utils/convertColor.js", () => {
  describe("isRgbArray", () => {
  ...
  describe("parseCssColorString", () => {
    it("should return an rgba array if a valid css color string is given", () => {
      ...
      expect(parseCssColorString("PaleGoldenRod")).to.deep.equal([
        238, 232, 170, 1,
      ]);
  ...
  describe("parseRgbColorString", () => {
    it("should return an rgba array if a valid rgb color string is given", () => {
      ...
      expect(parseRgbColorString("rgb(255, 255, 255)")).to.deep.equal([
        255, 255, 255, 1,
      ]);
    });
  });
  describe("parseRgbaColorString", () => {
    it("should return an rgba array if a valid rgba color string is given", () => {
      expect(parseRgbaColorString("rgba(0, 0, 0, 0)")).to.deep.equal([
        0, 0, 0, 0,
      ]);
      expect(parseRgbaColorString("rgba(255, 255, 255, 1)")).to.deep.equal([
        255, 255, 255, 1,
      ]);
    });
  });
  ...
  describe("convertToRgbArrayString", () => {
    it("should convert a valid rgba array into a hex color string", () => {
      ...
      expect(convertToRgbArrayString([255, 255, 255, 1])).to.equal(
        "[255, 255, 255]",
      );
    });
  });
  describe("convertToRgbaArrayString", () => {
    it("should convert a valid rgba array into a hex color string", () => {
      ...
      expect(convertToRgbaArrayString([255, 255, 255, 1])).to.equal(
        "[255, 255, 255, 1]",
      );
    });
  });
  describe("convertToRgbString", () => {
    it("should convert a valid rgba array into a hex color string", () => {
      ...
      expect(convertToRgbString([255, 255, 255, 1])).to.equal(
        "rgb(255, 255, 255)",
      );
    });
  });
  describe("convertToRgbaString", () => {
    it("should convert a valid rgba array into a hex color string", () => {
      ...
      expect(convertToRgbaString([255, 255, 255, 1])).to.equal(
        "rgba(255, 255, 255, 1)",
      );
    });
  });
  ...
  describe("convertColor", () => {
    ...
    it("should convert any form of color into an rgba array if no destination is given", () => {
      ...
      expect(convertColor([255, 255, 255, 1])).to.deep.equal([
        255, 255, 255, 1,
      ]);
      ...
      expect(convertColor("rgb(255, 255, 255)")).to.deep.equal([
        255, 255, 255, 1,
      ]);
      expect(convertColor("rgba(255, 255, 255, 1)")).to.deep.equal([
        255, 255, 255, 1,
      ]);
    });
    it("should convert any form of color into an rgba array if the destination is 'rgba'", () => {
      expect(convertColor([255, 255, 255], "rgba")).to.deep.equal([
        255, 255, 255, 1,
      ]);
      expect(convertColor([255, 255, 255, 1], "rgba")).to.deep.equal([
        255, 255, 255, 1,
      ]);
      ...
      expect(convertColor("rgb(255, 255, 255)", "rgba")).to.deep.equal([
        255, 255, 255, 1,
      ]);
      expect(convertColor("rgba(255, 255, 255, 1)", "rgba")).to.deep.equal([
        255, 255, 255, 1,
      ]);
    });
    it("should convert any form of color into an rgb array if the destination is 'rgb'", () => {
      expect(convertColor([255, 255, 255], "rgb")).to.deep.equal([
        255, 255, 255,
      ]);
      expect(convertColor([255, 255, 255, 1], "rgb")).to.deep.equal([
        255, 255, 255,
      ]);
      ...
      expect(convertColor("rgb(255, 255, 255)", "rgb")).to.deep.equal([
        255, 255, 255,
      ]);
      expect(convertColor("rgba(255, 255, 255, 1)", "rgb")).to.deep.equal([
        255, 255, 255,
      ]);
    });
    it("should convert any form of color into a hex color string if the destination is 'hex'", () => {
      ...
      expect(convertColor("[255, 255, 255]", "hex")).to.deep.equal("#ffffff");
      expect(convertColor("[255, 255, 255, 1]", "hex")).to.deep.equal(
        "#ffffff",
      );
      expect(convertColor("rgb(255, 255, 255)", "hex")).to.deep.equal(
        "#ffffff",
      );
      expect(convertColor("rgba(255, 255, 255, 1)", "hex")).to.deep.equal(
        "#ffffff",
      );
    });
    it("should convert any form of color into an rgb array string if the destination is 'rgbArrayString'", () => {
      expect(convertColor([255, 255, 255], "rgbArrayString")).to.deep.equal(
        "[255, 255, 255]",
      );
      expect(convertColor([255, 255, 255, 1], "rgbArrayString")).to.deep.equal(
        "[255, 255, 255]",
      );
      expect(convertColor("#ffffff", "rgbArrayString")).to.deep.equal(
        "[255, 255, 255]",
      );
      expect(convertColor("white", "rgbArrayString")).to.deep.equal(
        "[255, 255, 255]",
      );
      expect(convertColor("[255, 255, 255]", "rgbArrayString")).to.deep.equal(
        "[255, 255, 255]",
      ...
      expect(
        convertColor("[255, 255, 255, 1]", "rgbArrayString"),
      ).to.deep.equal("[255, 255, 255]");
      expect(
        convertColor("rgb(255, 255, 255)", "rgbArrayString"),
      ).to.deep.equal("[255, 255, 255]");
      expect(
        convertColor("rgba(255, 255, 255, 1)", "rgbArrayString"),
      ).to.deep.equal("[255, 255, 255]");
    });
    it("should convert any form of color into an rgba array string if the destination is 'rgbaArrayString'", () => {
      expect(convertColor([255, 255, 255], "rgbaArrayString")).to.deep.equal(
        "[255, 255, 255, 1]",
      );
      expect(convertColor([255, 255, 255, 1], "rgbaArrayString")).to.deep.equal(
        "[255, 255, 255, 1]",
      );
      expect(convertColor("#ffffff", "rgbaArrayString")).to.deep.equal(
        "[255, 255, 255, 1]",
      );
      expect(convertColor("white", "rgbaArrayString")).to.deep.equal(
        "[255, 255, 255, 1]",
      );
      expect(convertColor("[255, 255, 255]", "rgbaArrayString")).to.deep.equal(
        "[255, 255, 255, 1]",
      ...
      expect(
        convertColor("[255, 255, 255, 1]", "rgbaArrayString"),
      ).to.deep.equal("[255, 255, 255, 1]");
      expect(
        convertColor("rgb(255, 255, 255)", "rgbaArrayString"),
      ).to.deep.equal("[255, 255, 255, 1]");
      expect(
        convertColor("rgba(255, 255, 255, 1)", "rgbaArrayString"),
      ).to.deep.equal("[255, 255, 255, 1]");
    });
    it("should convert any form of color into an rgb string if the destination is 'rgbString'", () => {
      expect(convertColor([255, 255, 255], "rgbString")).to.deep.equal(
        "rgb(255, 255, 255)",
      );
      expect(convertColor([255, 255, 255, 1], "rgbString")).to.deep.equal(
        "rgb(255, 255, 255)",
      );
      expect(convertColor("#ffffff", "rgbString")).to.deep.equal(
        "rgb(255, 255, 255)",
      );
      expect(convertColor("white", "rgbString")).to.deep.equal(
        "rgb(255, 255, 255)",
      );
      expect(convertColor("[255, 255, 255]", "rgbString")).to.deep.equal(
        "rgb(255, 255, 255)",
      ...
      expect(convertColor("rgb(255, 255, 255)", "rgbString")).to.deep.equal(
        "rgb(255, 255, 255)",
      );
      expect(convertColor("rgba(255, 255, 255, 1)", "rgbString")).to.deep.equal(
        "rgb(255, 255, 255)",
      );
    });
    it("should convert any form of color into an rgb string if the destination is 'rgbaString'", () => {
      expect(convertColor([255, 255, 255], "rgbaString")).to.deep.equal(
        "rgba(255, 255, 255, 1)",
      );
      expect(convertColor([255, 255, 255, 1], "rgbaString")).to.deep.equal(
        "rgba(255, 255, 255, 1)",
      );
      expect(convertColor("#ffffff", "rgbaString")).to.deep.equal(
        "rgba(255, 255, 255, 1)",
      );
      expect(convertColor("white", "rgbaString")).to.deep.equal(
        "rgba(255, 255, 255, 1)",
      );
      expect(convertColor("[255, 255, 255]", "rgbaString")).to.deep.equal(
        "rgba(255, 255, 255, 1)",
      ...
      expect(convertColor("rgb(255, 255, 255)", "rgbaString")).to.deep.equal(
        "rgba(255, 255, 255, 1)",
      );
      expect(
        convertColor("rgba(255, 255, 255, 1)", "rgbaString"),
      ).to.deep.equal("rgba(255, 255, 255, 1)");
    });
  });
});
