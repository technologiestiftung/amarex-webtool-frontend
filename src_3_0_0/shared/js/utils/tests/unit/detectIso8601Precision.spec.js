...
describe("src_3_0_0/utils/detectIso8601Precision.js", () => {
  describe("detectIso8601Precision", () => {
    ...
    it("should throw an error if the given string is no valid Iso 8601 time format", () => {
      ...
      expect(() =>
        detectIso8601Precision("2022-11-30T23:59:59.1111"),
      ).to.throw();
    });
    it("should return the iso 8601 of the given string if a valid iso 8601 datetime is given", () => {
      ...
      expect(detectIso8601Precision("2022-11-30T23:59")).to.equal(
        "YYYY-MM-DDTHH:mm",
      );
      expect(detectIso8601Precision("2022-11-30T23:59:59")).to.equal(
        "YYYY-MM-DDTHH:mm:ss",
      );
      expect(detectIso8601Precision("2022-11-30T23:59:59.111")).to.equal(
