...
describe("src_3_0_0/shared/js/utils/thousandsSeparator.js", () => {
  ...
  it("should add the given letter(s) as decimal point", () => {
    expect(thousandsSeparator(1000.1, "delimAbs", "delimDec")).to.equal(
      "1delimAbs000delimDec1",
    );
  });
  ...
  it("should be able to add a higher number of thousands separators", () => {
    expect(thousandsSeparator(1123456789.123456)).to.equal(
      "1.123.456.789,123456",
    );
  });
