...
describe("src_3_0_0/shared/js/utils/getWKTGeom.js", () => {
  it("should return a feature with geometryType and POLYGON coordinates", () => {
    ...
    expect(WKTUtil.getWKTGeom(content, geometryType).getGeometry()).is.not
      .undefined;
    expect(
      WKTUtil.getWKTGeom(content, geometryType).getGeometry().getCoordinates(),
    ).to.deep.equal([
      [
  ...
  it("should return a feature with geometryType and POINT coordinates", () => {
    ...
    expect(
      WKTUtil.getWKTGeom(content, geometryType).getGeometry().getCoordinates(),
    ).to.deep.equal([570374.959, 5936460.361]);
  });
  ...
  it("should return a feature with POLYGON coordinates by given content as object", () => {
    ...
    expect(
      WKTUtil.getWKTGeom(content).getGeometry().getCoordinates(),
    ).to.deep.equal([
      [
        [570374.959, 5936460.361],
        [570369.316, 5936458.5],
  ...
  it("should return a feature with POLYGON with voids coordinates by given content as object", () => {
    ...
    expect(
      ...
      [
        [633653.19, 5647452.77],
        [633528.15, 5647303.82],
        [633517.51, 5647293.52],
        [633502.96, 5647282.23],
        [633653.19, 5647452.77],
      ],
      [
      ...
      [
        ...
        [634109.727, 5646798.55],
        [634104.507, 5646805.33],
        [634100.089, 5646811.41],
        [634037.745, 5646804.502],
      ],
    ]);
  });
