...
function downloadBlobPerHTML5(blob, filename, onerror = false) {
  ...
  if (
    typeof link?.download === "undefined" ||
    typeof URL?.createObjectURL !== "function"
  ) {
    if (typeof onerror === "function") {
      onerror(
        "ExportButtonCSV: this browser does not support HTML5 download attribute",
      );
    }
    return false;
  }
...
export { createCsvBlob, downloadBlobPerNavigator, downloadBlobPerHTML5 };
