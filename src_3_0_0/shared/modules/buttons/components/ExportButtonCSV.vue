  ...
  methods: {
    ...
    handleDownloadError(msg) {
      ...
      this.$store.dispatch(
        ...
        i18next.t("common:shared.modules.buttons.error.download"),
      );
    },
    /**
    ...
    download() {
      ...
      const filename =
        typeof this.filename === "string"
          ? this.createFilename(this.filename, this.postfixFormat)
          : false;
      ...
      if (typeof this.data === "object" && this.data !== null) {
        ...
        this.handleDownloadError(
          "ExportButtonCSV: no data, handler or url was given to download something",
        );
        this.enableDownload();
      }
    },
    ...
    fakeDownloadCsvText(csvText, filename, onerror) {
      ...
      if (
        downloadBlobPerNavigator(blob, filename) ||
      ...
      if (typeof onerror === "function") {
        onerror(
          "ExportButtonCSV: Neither navigator nor html5 technic available for download.",
        );
      }
      ...
      axios
        ...
        .then((response) => {
          if (!Object.prototype.hasOwnProperty.call(response, "data")) {
            if (typeof onerror === "function") {
              onerror(
                "ExportButtonCSV: the called url generates no valid axios data attribute - " +
                  url,
              );
              return;
            }
