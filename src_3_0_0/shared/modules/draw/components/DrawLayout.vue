  ...
  computed: {
    ...
    mappingLayoutBySelectedDrawType() {
      ...
      Object.keys(this.mappingLayout).forEach((layout) => {
        if (
          this.mappingLayout[layout]?.drawTypes?.includes(this.selectedDrawType)
        ) {
  ...
  <div class="d-flex flex-column">
      ...
      >
        ...
        >
          ...
          <input
            ...
            @input="
              (event) => updateCurrentLayout(layoutKey, event.target.value)
            "
          />
        </label>
        <label
    ...
    >
      <SliderItem
        ...
        :step="1"
        :interaction="
          (event) => updateCurrentLayout('strokeWidth', event.target.value)
        "
      />
    </div>
    <div
    ...
    >
      <SliderItem
        ...
        :step="1"
        :interaction="
          (event) => updateCurrentLayout('fillTransparency', event.target.value)
        "
      />
    </div>
  </div>
