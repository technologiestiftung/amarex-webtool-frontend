...
export default {
  ...
  watch: {
    "circleOptions.interactive"() {
      if (
        this.selectedDrawType === "circle" ||
        this.selectedDrawType === "doubleCircle"
      ) {
  ...
  methods: {
    ...
    regulateInteraction(drawType) {
      ...
      if (
        typeof this.setSelectedDrawTypeMain === "function" &&
        this.drawTypes.includes(drawType)
      ) {
        this.setSelectedDrawTypeMain(
          this.selectedDrawTypeMain !== drawType ? drawType : "",
        );
        this.setSelectedDrawType("");
      }
    ...
    regulateDrawInteraction(drawType) {
      this.currentDrawInteraction = drawInteraction.createDrawInteraction(
        drawType,
        this.source,
      );
  ...
  <div class="d-flex align-items-center">
    <IconButton
      ...
      :class-array="[
        'btn-primary',
        'me-3',
        selectedDrawType === drawType || selectedDrawTypeMain === drawType
          ? 'active'
          : '',
      ]"
