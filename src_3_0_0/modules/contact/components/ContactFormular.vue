  ...
  methods: {
          ...
          reader.addEventListener(
            ...
            () => {
              ...
              if (
                ...
                fileExtension === "jpg" ||
                fileExtension === "jpeg" ||
                this.configuredFileExtensions.includes(fileExtension)
              ) {
                this.fileUploaded = true;
                const src = file.type.includes("image")
                  ? reader.result
    ...
    checkValid(file) {
      if (
        ...
        this.configuredFileExtensions.length === 0
      ) {
        this.addSingleAlert({
          category: "error",
          content: this.$t("common:modules.contact.fileFormatMessage"),
  ...
  <div id="contact-formular">
    ...
    <form @submit.prevent="send">
      ...
      >
        ...
        <p
          v-html="
            $t('common:modules.contact.privacyPolicy.info', {
              privacyPolicyLink,
            })
          "
        />
