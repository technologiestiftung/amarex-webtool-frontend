...
describe("src_3_0_0/modules/contact/components/ContactFormular.vue", () => {
  ...
  it("optionally renders an additional info field and privacy policy checkbox; must tick checkbox to send form", async () => {
    ContactModule.state.contactInfo =
      "If you live nearby, why not shout the message out from your window at 3AM?";
    ...
    expect(wrapper.find("#module-contact-addionalInformation").exists()).to.be
      .true;
  ...
  it("sets focus to first input control", async () => {
    ...
    await wrapper.vm.$nextTick();
    expect(wrapper.find("#module-contact-username-input").element).to.equal(
