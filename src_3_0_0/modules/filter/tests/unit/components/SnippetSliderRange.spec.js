  ...
  describe("mounted", () => {
    ...
    describe("template", () => {
      it("should render itself", () => {
        ...
        expect(wrapper.find("div").classes("snippetSliderRangeContainer")).to.be
          .true;
      });
      ...
      describe("inputWrapper", () => {
        ...
        describe("prechecked", () => {
          it("should set value to both endings if no prechecked is given", async () => {
            ...
            await wrapper.vm.$nextTick();
            expect(
              wrapper.find(".inputWrapper").find(".from").find("input").element
                .value,
            ).to.equal("8");
            expect(
              wrapper.find(".inputWrapper").find(".until").find("input").element
                .value,
            ).to.equal("90");
          });
      ...
      describe("sliderWrapper", () => {
        describe("disabling and enabling inputs", () => {
          it("should add disabledClass to CSS classes if prop disabled is true", async () => {
            ...
            expect(wrapper.find(".measure").classes()).to.include(
              "disabledClass",
            );
          });
          it("should verify absence of disabledClass if prop disabled is false", async () => {
            ...
            expect(wrapper.find(".measure").classes()).to.not.include(
              "disabledClass",
            );
          });
        });
