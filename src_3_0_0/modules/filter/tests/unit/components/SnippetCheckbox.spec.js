...
describe("src_3_0_0/modules/filter/components/SnippetCheckbox.vue", () => {
  describe("constructor", () => {
    ...
    it("should render hidden if visible is false", () => {
      ...
      expect(
        wrapper.find(".snippetCheckboxContainer").element.style._values.display,
      ).to.be.equal("none");
    });
    it("should render with checked box if prechecked is true", () => {
      ...
      expect(wrapper.find(".snippetCheckbox").element.checked).to.be.equal(
        true,
      );
    });
    ...
    it("should render with a title if the title is a string", () => {
      ...
      expect(wrapper.find(".snippetCheckboxLabel").text()).to.be.equal(
        "foobar",
      );
    });
