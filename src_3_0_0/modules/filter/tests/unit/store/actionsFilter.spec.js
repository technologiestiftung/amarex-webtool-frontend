    ...
    it("update rules by given rule", (done) => {
      ...
      testAction(
        ...
        [
          {
            type: "addSpotForRule",
            payload: { filterId: payload.filterId },
            commit: true,
          },
          {
            type: "updateRules",
    ...
    it("deserialize the state", (done) => {
      ...
      testAction(
        ...
        [
          {
            type: "setRulesArray",
            payload: { rulesOfFilters },
            dispatch: true,
          },
          {
            type: "setSelectedAccordions",
            payload: selectedAccordions,
            commit: true,
          },
          { type: "setSelectedGroups", payload: [], commit: true },
          {
            type: "setGeometryFilterByFeature",
            payload: { jsonFeature: geometryFeature, invert: true },
            dispatch: true,
          },
          {
            type: "setGeometrySelectorOptions",
            payload: geometrySelectorOptions,
            commit: true,
          },
          {
            type: "setAdditionalGeometries",
            payload: { additionalGeometries },
            commit: true,
          },
        ],
        {},
