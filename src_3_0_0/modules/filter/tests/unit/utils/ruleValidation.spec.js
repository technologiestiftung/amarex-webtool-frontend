...
describe("src_3_0_0/modules/filter/utils/ruleValidation.js", () => {
  ...
  describe("betweenForArray", () => {
    ...
    it("should return true if dates are between", () => {
      expect(
        betweenForArray("01.01.2022", "02.01.2022", "01.01.2022", "10.01.2022"),
      ).to.be.true;
    });
    it("should return false if dates are not between", () => {
      expect(
        betweenForArray("31.12.2021", "11.01.2022", "01.01.2022", "10.01.2022"),
      ).to.be.false;
    });
  });
  describe("equalsForArray", () => {
    ...
    it("should return true if multi value is equal to one of the value split from delimiter", () => {
      expect(equalsForArray("foo|bar", ["foo", "foo"], undefined, "|")).to.be
        .true;
    });
    it("should return false if multi value is equal to none of the value split from delimiter", () => {
      expect(equalsForArray("bars|bar", ["foo", "foo"], undefined, "|")).to.be
        .false;
    });
  ...
  describe("between", () => {
    ...
    it("should return false if date is not between", () => {
      expect(between("01.01.2022", "10.01.2022", "31.12.2021", "DD.MM.YYYY")).to
        .be.false;
      expect(between("01.01.2022", "10.01.2022", "11.01.2022", "DD.MM.YYYY")).to
        .be.false;
      expect(between("01.01.2022", "10.01.2022", "05.01.2021", "DD.MM.YYYY")).to
        .be.false;
    });
    it("should return true if date is between", () => {
      expect(between("01.01.2022", "10.01.2022", "05.01.2022", "DD.MM.YYYY")).to
        .be.true;
      expect(between("01.01.2022", "10.01.2022", "01.01.2022", "DD.MM.YYYY")).to
        .be.true;
      expect(between("01.01.2022", "10.01.2022", "10.01.2022", "DD.MM.YYYY")).to
        .be.true;
    });
  });
  describe("equals", () => {
