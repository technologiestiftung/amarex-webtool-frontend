...
describe("src_3_0_0/modules/filter/utils/getSnippetAdjustments.js", () => {
  describe("getMergedValuesByAttrNames", () => {
    ...
    it("should return an empty array if second param do not include values for first param", () => {
      expect(getMergedValuesByAttrNames(["foo"], { bar: "buz" })).to.be.an(
        "array",
      ).and.to.be.empty;
    });
    it("should return an expected array", () => {
      ...
      expect(
        getMergedValuesByAttrNames(["foo", "bar"], {
          foo: ["woo", "boo"],
          bar: "loo",
        }),
  ...
  describe("getListOfRelevantAttrNames", () => {
    it("should return an empty array if anything but an array or empty array is given", () => {
      expect(getListOfRelevantAttrNames(undefined)).to.be.an("array").and.to.be
        .empty;
      expect(getListOfRelevantAttrNames(null)).to.be.an("array").and.to.be
        .empty;
      expect(getListOfRelevantAttrNames("string")).to.be.an("array").and.to.be
        .empty;
      expect(getListOfRelevantAttrNames(1234)).to.be.an("array").and.to.be
        .empty;
      expect(getListOfRelevantAttrNames(true)).to.be.an("array").and.to.be
        .empty;
      expect(getListOfRelevantAttrNames(false)).to.be.an("array").and.to.be
        .empty;
    ...
    it("should return an empty array if the given array includes no objects with attrName key", () => {
      expect(
        getListOfRelevantAttrNames([{}, { somekey: "somevalue" }]),
      ).to.be.an("array").and.to.be.empty;
    });
  ...
  describe("getAttrValuesOfItemsGroupedByAttrNames", () => {
    it("should return an empty object if the first argument is not an array", () => {
      expect(getAttrValuesOfItemsGroupedByAttrNames(undefined)).to.be.an(
        "object",
      ).and.to.be.empty;
      expect(getAttrValuesOfItemsGroupedByAttrNames(null)).to.be.an("object")
        .and.to.be.empty;
      expect(getAttrValuesOfItemsGroupedByAttrNames("string")).to.be.an(
        "object",
      ).and.to.be.empty;
      expect(getAttrValuesOfItemsGroupedByAttrNames(1234)).to.be.an("object")
        .and.to.be.empty;
      expect(getAttrValuesOfItemsGroupedByAttrNames(true)).to.be.an("object")
        .and.to.be.empty;
      expect(getAttrValuesOfItemsGroupedByAttrNames(false)).to.be.an("object")
        .and.to.be.empty;
      expect(getAttrValuesOfItemsGroupedByAttrNames({})).to.be.an("object").and
        .to.be.empty;
    });
    it("should return an empty object if the second argument is not an array", () => {
      ...
      expect(getAttrValuesOfItemsGroupedByAttrNames([], null)).to.be.an(
        "object",
      ).and.to.be.empty;
      expect(getAttrValuesOfItemsGroupedByAttrNames([], "string")).to.be.an(
        "object",
      ).and.to.be.empty;
      expect(getAttrValuesOfItemsGroupedByAttrNames([], 1234)).to.be.an(
        "object",
      ).and.to.be.empty;
      expect(getAttrValuesOfItemsGroupedByAttrNames([], true)).to.be.an(
        "object",
      ).and.to.be.empty;
      expect(getAttrValuesOfItemsGroupedByAttrNames([], false)).to.be.an(
        "object",
      ).and.to.be.empty;
      expect(getAttrValuesOfItemsGroupedByAttrNames([], {})).to.be.an("object")
        .and.to.be.empty;
    });
    it("should return an empty object if the first argument is an empty array", () => {
      expect(
        getAttrValuesOfItemsGroupedByAttrNames([], ["something"]),
    ...
    it("should return an empty object if the first argument is valid and the second argument is empty", () => {
      expect(
        getAttrValuesOfItemsGroupedByAttrNames([{ get: () => false }], []),
      ).to.be.an("object").and.to.be.empty;
    });
    it("should return an empty object if the second argument includes no valid attr names", () => {
      expect(
        getAttrValuesOfItemsGroupedByAttrNames(
          [{ get: () => false }],
          [undefined, null, 1234, true, false, {}, []],
        ),
      ).to.be.an("object").and.to.be.empty;
    });
  ...
  describe("snippetDateCompareFunction", () => {
    it("should return 1 if the first argument is not a valid date string", () => {
      expect(
        snippetDateCompareFunction("test", "04.02.2022", "DD.MM.YYYY"),
      ).to.equal(1);
    });
    it("should return -1 if the second argument is not a valid date string", () => {
      expect(
        snippetDateCompareFunction("04.02.2022", "test", "DD.MM.YYYY"),
      ).to.equal(-1);
    });
    it("should return -1 if the first argument is same or before the second argument", () => {
      expect(
        snippetDateCompareFunction("03.02.2022", "04.02.2022", "DD.MM.YYYY"),
      ).to.equal(-1);
      expect(
        snippetDateCompareFunction("04.02.2022", "04.02.2022", "DD.MM.YYYY"),
      ).to.equal(-1);
    });
    it("should return 1 if the first argument is greater than the second argument", () => {
      expect(
        snippetDateCompareFunction("05.02.2022", "04.02.2022", "DD.MM.YYYY"),
      ).to.equal(1);
    });
  });
