...
describe("src_3_0_0/modules/filter/utils/getDefaultOperatorBySnippetType.js", () => {
  describe("getDefaultOperatorBySnippetType", () => {
    it("should return operator according to the input snippet type", () => {
      ...
      expect(getDefaultOperatorBySnippetType("dateRange")).to.equal(
        "INTERSECTS",
      );
      ...
      expect(getDefaultOperatorBySnippetType("sliderRange")).to.equal(
        "BETWEEN",
      );
    });
    it("should return expected operator if the second parameter is set to true", () => {
      ...
      expect(getDefaultOperatorBySnippetType("dateRange", true)).to.equal(
        "INTERSECTS",
      );
      ...
      expect(getDefaultOperatorBySnippetType("sliderRange", true)).to.equal(
        "BETWEEN",
      );
    });
  });
