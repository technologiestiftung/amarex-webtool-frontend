...
describe("src_3_0_0/modules/filter/interfaces/utils/interface.vectortiles.intern.js", () => {
  ...
  describe("getAttrTypes", () => {
    it("should call onerror function, if layermodel doesn't exist", () => {
      const stubGetLayerByLayerId = sinon
          .stub(layerCollection, "getLayerById")
          .returns(null),
        service = { layerId: 1 },
        onsuccess = undefined,
        expectedError = new Error(
          "InterfaceVectorTilesIntern.getAttrTypes: cannot find layer model for given layerId 1.",
        );
    ...
    it("should call the onsuccess function and return an empty list if no features in current extent", () => {
      ...
      interfaceVectorTilesIntern.getAttrTypes(
        {},
        (attrTypes) => {
  ...
  describe("getMinMax", () => {
    it("should call onerror function, if layermodel doesn't exist", () => {
      const stubGetLayerByLayerId = sinon
        ...
        onsuccess = undefined,
        expectedError = new Error(
          "InterfaceVectorTilesIntern.getMinMax: cannot find layer model for given layerId 1.",
        );

      interfaceVectorTilesIntern.getMinMax(
        service,
        attrName,
        onsuccess,
        (error) => {
  ...
  describe("getUniqueValues", () => {
    it("should call onerror function, if layermodel doesn't exist", () => {
      const stubGetLayerByLayerId = sinon
        ...
        onsuccess = undefined,
        expectedError = new Error(
          "InterfaceVectorTilesIntern.getUniqueValues: cannot find layer model for given layerId 1.",
        );

      interfaceVectorTilesIntern.getUniqueValues(
        service,
        attrName,
        onsuccess,
        (error) => {
  ...
  describe("filterGivenFeatures", () => {
    it("should start the filtering process and return the expected items", () => {
      ...
      interfaceVectorTilesIntern.filterGivenFeatures(
        [feature],
        0,
        0,
        {},
