...
export default class FilterApi {
    ...
    if (!(FilterApi.intervalRegister instanceof IntervalRegister)) {
      ...
      FilterApi.interfaces = {
        ...
        wfsExtern: new InterfaceWfsExtern({
          getCurrentExtent: openlayerFunctions.getCurrentExtent,
        }),
        ...
        vectortilesIntern: new InterfaceVectorTilesIntern(
          FilterApi.intervalRegister,
          {
            getFeaturesByLayerId:
              openlayerFunctions.getVectorTileFeaturesByLayerId,
            isFeatureInMapExtent: openlayerFunctions.isFeatureInMapExtent,
            isFeatureInGeometry: openlayerFunctions.isFeatureInGeometry,
          },
        ),
    ...
    if (type === "wfs") {
      ...
      if (!extern) {
        this.service = {
          ...
          namespace: featureNS,
          limit:
            typeof layerModel.limit === "undefined" ? 400 : layerModel.limit,
        };
      } else {
        onerror(
          new Error(
            "FilterApi.setServiceByLayerModel: Filtering oaf extern is not supported yet.",
          ),
        );
      }
      ...
      if (!extern) {
        ...
        onerror(
          new Error(
            "FilterApi.setServiceByLayerModel: Filtering geojson extern is not supported.",
          ),
        );
      }
      ...
      if (!extern) {
        ...
        onerror(
          new Error(
            "FilterApi.setServiceByLayerModel: Filtering sta extern is not supported.",
          ),
        );
      }
      ...
      if (!extern) {
        ...
        onerror(
          new Error(
            "FilterApi.setServiceByLayerModel: Filtering vectortiles extern is not supported.",
          ),
        );
      }
      ...
      onerror(
        new Error(
          "FilterApi.setServiceByLayerModel: Unknown layer type " + type,
        ),
      );
    }
  }
  ...
  getAttrTypes(onsuccess, onerror) {
    if (!isObject(this.service)) {
      if (typeof onerror === "function") {
        onerror(
          new Error(
            "FilterApi.getAttrTypes: You have to set a default service first before using this function.",
          ),
        );
      }
      return;
    ...
    const connector = this.getInterfaceByService(this.service, onerror),
      cacheKey = hash.sha1(
        ["getAttrTypes", JSON.stringify(this.service)].join("."),
      );
    ...
    if (Object.prototype.hasOwnProperty.call(FilterApi.cache, cacheKey)) {
      ...
      !isObject(connector) ||
      typeof connector.getAttrTypes !== "function"
    ) {
      if (typeof onerror === "function") {
        onerror(
          new Error(
            "FilterApi.getAttrTypes: The connector should be an object and have a function getAttrTypes.",
          ),
        );
      }
  ...
  getMinMax(
    ...
    if (!isObject(this.service)) {
      if (typeof onerror === "function") {
        onerror(
          new Error(
            "FilterApi.getMinMax: You have to set a default service first before using this function.",
          ),
        );
      }
      return;
    ...
    if (Object.prototype.hasOwnProperty.call(FilterApi.cache, cacheKey)) {
      ...
      !isObject(connector) ||
      typeof connector.getMinMax !== "function"
    ) {
      if (typeof onerror === "function") {
        onerror(
          new Error(
            "FilterApi.getMinMax: The connector should be an object and have a function getMinMax.",
          ),
        );
      }
    } else if (!Array.isArray(FilterApi.waitingList[cacheKey])) {
  ...
  getUniqueValues(attrName, onsuccess, onerror, { rules, filterId, commands }) {
    if (!isObject(this.service)) {
      if (typeof onerror === "function") {
        onerror(
          new Error(
            "FilterApi.getUniqueValues: You have to set a default service first before using this function.",
          ),
        );
      }
      return;
    ...
    if (Object.prototype.hasOwnProperty.call(FilterApi.cache, cacheKey)) {
      ...
      !isObject(connector) ||
      typeof connector.getUniqueValues !== "function"
    ) {
      if (typeof onerror === "function") {
        onerror(
          new Error(
            "FilterApi.getUniqueValues: The connector should be an object and have a function getUniqueValues.",
          ),
        );
      }
    } else if (!Array.isArray(FilterApi.waitingList[cacheKey])) {
  ...
  filter(filterQuestion, onsuccess, onerror) {
    if (!isObject(this.service)) {
      if (typeof onerror === "function") {
        onerror(
          new Error(
            "FilterApi.filter: You have to set a default service first before using this function.",
          ),
        );
      }
      return;
    ...
    if (isObject(connector) && typeof connector.filter === "function") {
      connector.filter(
        Object.assign(filterQuestion, { service: this.service }),
        onsuccess,
        onerror,
      );
    }
  ...
  stop(onsuccess, onerror) {
    if (!isObject(this.service)) {
      if (typeof onerror === "function") {
        onerror(
          new Error(
            "FilterApi.stop: You have to set a default service first before using this function.",
          ),
        );
      }
      return;
  ...
  getInterfaceByService(service, onerror) {
    const type =
      isObject(service) && typeof service.type === "string"
    ...
    if (type === "wfs" && !service.extern) {
      ...
      onerror(
        new Error(
          "FilterApi.getInterfaceByService: Unknown service type " + type,
        ),
      );
    }
    return false;
