...
} from "../../utils/fetchAllOafProperties";
...
export default class InterfaceVectorTilesIntern {
  ...
  constructor(
    ...
    this.interfaceWFSIntern = new InterfaceWfsIntern(intervalRegister, {
  ...
  getAttrTypes(service, onsuccess, onerror) {
    ...
    if (!layerModel) {
      if (typeof onerror === "function") {
        onerror(
          new Error(
            `InterfaceVectorTilesIntern.getAttrTypes: cannot find layer model for given layerId ${layerId}.`,
          ),
        );
      }
      return;
    ...
    featuresInCurrentExtent = layerModel
      .getLayerSource()
      .getFeaturesInExtent(store.getters["Maps/extent"]);
  ...
  getMinMax(service, attrName, onsuccess, onerror, minOnly, maxOnly) {
    ...
    if (!layerModel) {
      if (typeof onerror === "function") {
        onerror(
          new Error(
            `InterfaceVectorTilesIntern.getMinMax: cannot find layer model for given layerId ${layerId}.`,
          ),
        );
      }
      return;
    ...
    minMaxValues = getMinMaxFromFetchedFeatures(
      allFetchedProperties,
      attrName,
      minOnly,
      maxOnly,
    ...
    if (minMaxValues === false) {
      if (typeof onerror === "function") {
        onerror(
          new Error(
            "InterfaceVectorTilesIntern.getMinMax: an error occurred during the creation of min max values.",
          ),
        );
      }
      return;
  ...
  getUniqueValues(service, attrName, onsuccess, onerror) {
    ...
    if (!layerModel) {
      if (typeof onerror === "function") {
        onerror(
          new Error(
            `InterfaceVectorTilesIntern.getUniqueValues: cannot find layer model for given layerId ${layerId}.`,
          ),
        );
      }
      return;
    ...
    uniqueValues = getUniqueValuesFromFetchedFeatures(
      allFetchedProperties,
      attrName,
    );
    if (uniqueValues === false) {
      if (typeof onerror === "function") {
        onerror(
          new Error(
            "InterfaceVectorTilesIntern.getUniqueValues: an error occurred during the creation of unique values.",
          ),
        );
      }
      return;
  ...
  stop(filterId, onsuccess, onerror) {
    if (typeof this.intervalRegister?.stopPagingInterval !== "function") {
      if (typeof onerror === "function") {
        onerror(
          new Error(
            "InterfaceVectorTilesIntern.stop: invalid intervalRegister",
          ),
        );
      }
      return;
  ...
  filter(filterQuestion, onsuccess, onerror) {
    if (
      ...
      if (typeof onerror === "function") {
        onerror(
          new Error(
            "InterfaceVectorTilesIntern.filter: invalid intervalRegister",
          ),
        );
      }
      return;
      ...
      if (typeof onerror === "function") {
        onerror(
          new Error(
            "InterfaceVectorTilesIntern.filter: getFeaturesByLayerId must be a function",
          ),
        );
      }
      return;
      ...
      if (typeof onerror === "function") {
        onerror(
          new Error(
            "InterfaceVectorTilesIntern.filter: isFeatureInMapExtent must be a function",
          ),
        );
      }
      return;
      ...
      if (typeof onerror === "function") {
        onerror(
          new Error(
            "InterfaceVectorTilesIntern.filter: isFeatureInGeometry must be a function",
          ),
        );
      }
      return;
      ...
      if (typeof onerror === "function") {
        onerror(
          new Error(
            "InterfaceVectorTilesIntern.filter: filterQuestion must be an object",
          ),
        );
      }
      return;
  ...
  changeValueToMatchReference(value, reference, depth = 0) {
    return this.interfaceWFSIntern.changeValueToMatchReference(
      value,
      reference,
      depth,
    );
