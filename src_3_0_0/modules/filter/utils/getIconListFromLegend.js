...
function getIconListFromLegend(legendInfoList, styleModel) {
  ...
  legendInfoList?.forEach((legendInfo) => {
    ...
    if (legendInfo.styleObject.type === "icon") {
      result[legendInfo.label] =
        legendInfo.styleObject.imagePath + legendInfo.styleObject.imageName;
      ...
      if (legendInfo.geometryType === "Point") {
        ...
        result[legendInfo.label] = svgFactory.createLine(
          legendInfo.styleObject,
        );
      } else if (legendInfo.geometryType === "Polygon") {
        result[legendInfo.label] = svgFactory.createPolygon(
          legendInfo.styleObject,
        );
      }
    }
