...
describe("src_3_0_0/modules/coord/store/actionsCoordToolkit.js", () => {
  ...
  describe("supplyCoord actions", () => {
    ...
    it("retrieveHeightFromGfiResponse - real height", (done) => {
      ...
      testAction(
        actions.retrieveHeightFromGfiResponse,
        payload,
        state,
        {},
    ...
    it("newProjectionSelected", (done) => {
      ...
      testAction(
        ...
        [
          ...
          {
            type: "transformCoordinatesFromTo",
            payload: proj2,
            dispatch: true,
          },
    ...
    describe("setFirstSearchPosition", () => {
      ...
      it("setFirstSearchPosition will call setCoordinatesEasting and others if position is not set", (done) => {
        ...
        testAction(
          actions.setFirstSearchPosition,
          null,
          state,
          rootState,
          [
    ...
    describe("adjustPosition", () => {
      ...
      it("adjustPosition sets coordinate fields - longlat", (done) => {
        ...
        testAction(
          actions.adjustPosition,
          payload,
          {},
          rootState,
          [
            {
              type: "setCoordinatesEasting",
              payload: { id: "easting", value: "160° 00′ 00″" },
            },
            {
              type: "setCoordinatesNorthing",
              payload: { id: "northing", value: "100° 00′ 00″" },
            },
          ],
          {},
          done,
      ...
      it("adjustPosition sets coordinate fields - longlat - decimal degree", (done) => {
        ...
        testAction(
          ...
          [
            {
              type: "setCoordinatesEasting",
              payload: { id: "easting", value: "160.0000°" },
            },
            {
              type: "setCoordinatesNorthing",
              payload: { id: "northing", value: "100.0000°" },
            },
          ],
          {},
          done,
      ...
      it("adjustPosition sets coordinate fields - utm", (done) => {
        ...
        testAction(
          ...
          [
            {
              type: "setCoordinatesEasting",
              payload: { id: "easting", value: "100.00" },
            },
            {
              type: "setCoordinatesNorthing",
              payload: { id: "northing", value: "200.00" },
            },
          ],
          {},
          done,
  ...
  describe("searchByCoord actions", () => {
    describe("validateInput", () => {
      ...
      it("Validates the coordinates according to the ETRS893GK3 coordinate system", () => {
        const state = {
          currentProjection: {
            id: "http://www.opengis.net/gml/srs/epsg.xml#ETRS893GK3",
          },
          coordinatesEasting: {
            id: "easting",
            name: "",
    ...
    describe("formatInput", () => {
      it("Does not format coordinates of the ETRS89 format and moves to coordinates", () => {
        ...
        actions.formatInput({ state, commit, getters }, [
          state.coordinatesEasting,
          state.coordinatesNorthing,
        ]);
    ...
    describe("transformCoordinates", () => {
      ...
      it("Transforms coordinates of the EPSG:31467 format and moves to coordinates", () => {
        const state = {
          currentProjection: {
            id: "http://www.opengis.net/gml/srs/epsg.xml#31467",
            epsg: "EPSG:31467",
          },
      ...
      it("Transforms coordinates of the EPSG:8395 format and moves to coordinates", () => {
        const state = {
          currentProjection: {
            id: "http://www.opengis.net/gml/srs/epsg.xml#8395",
            epsg: "EPSG:8395",
          },
          selectedCoordinates: ["53.55555", "10.01234"],
        };
