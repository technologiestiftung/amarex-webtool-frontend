  ...
  computed: {
    ...
    eastingNoCoordMessage: function () {
      if (this.currentProjection.projName !== "longlat") {
        return this.$t("common:modules.coordToolkit.errorMsg.noCoord", {
          valueKey: this.$t(this.getLabel("eastingLabel")),
        });
      }
      return this.$t("common:modules.coordToolkit.errorMsg.hdmsNoCoord", {
        valueKey: this.$t(this.getLabel("eastingLabel")),
      });
    },
    ...
    northingNoMatchMessage: function () {
      if (this.currentProjection.projName !== "longlat") {
        return this.$t("common:modules.coordToolkit.errorMsg.noMatch", {
          valueKey: this.$t(this.getLabel("northingLabel")),
        });
      }
      return this.$t("common:modules.coordToolkit.errorMsg.hdmsNoMatch", {
        valueKey: this.$t(this.getLabel("northingLabel")),
      });
    },
  ...
  methods: {
    ...
    copyCoords(ids) {
      ...
      if (Array.isArray(values)) {
        ...
        console.warn(
          "Cannot copy coordinates to clipboard, coordinates:",
          values,
        );
      }
    },
  ...
  <div id="coord-toolkit">
    ...
    >
      ...
      <div class="form-floating mb-3">
        ...
        <label for="coordSystemField">{{
          $t("common:modules.coordToolkit.coordSystemField")
        }}</label>
      </div>
      <div :class="getClassForEasting()">
        <InputText
          ...
          :placeholder="
            isEnabled('search')
              ? $t('common:modules.coordToolkit.exampleAcronym') +
                coordinatesEastingExample
              : ''
          "
        ...
        >
          ...
          >
            <button
              ...
              :title="
                $t(`common:modules.coordToolkit.copyCoordBtn`, {
        ...
        <transition name="fade">
          ...
          >
            ...
            {{
              $t("common:modules.coordToolkit.errorMsg.example") +
              coordinatesEastingExample
            }}
          </p>
        </transition>
      ...
      >
        {{
          $t("common:modules.coordToolkit.name") +
          ": " +
        ...
        <button
          ...
          @click="
            copyCoords(['coordinatesEastingField', 'coordinatesNorthingField'])
          "
        >
          <span
            class="bootstrap-icon"
