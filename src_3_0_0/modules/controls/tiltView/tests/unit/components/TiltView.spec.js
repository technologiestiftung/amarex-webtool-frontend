...
describe("src_3_0_0/modules/controls/button3d/components/TiltView.vue", () => {
  let lookDownSpy, lookUpSpy, map3d, store;
  ...
  it("renders the TiltView button", () => {
    ...
    expect(wrapper.find("#tilt-view-button > #tilt-view-up").exists()).to.be
      .true;
    expect(wrapper.find("#tilt-view-button > #tilt-view-down").exists()).to.be
      .true;
