...
export default {
  ...
  created() {
    this.setConfiguredModuleStates({
      menuModels: this.mainMenu,
      menuSide: "mainMenu",
    });
    this.setConfiguredModuleStates({
      menuModels: this.secondaryMenu,
      menuSide: "secondaryMenu",
    });
  },
  methods: {
    ...mapActions("Controls/StartModule", [
    ...
    >
      <ControlIcon
        ...
        :on-click="
          () =>
            onClick({
              moduleState: configuredModule.state,
              menuSide: configuredModule.menuSide,
            })
        "
      />
    </template>
