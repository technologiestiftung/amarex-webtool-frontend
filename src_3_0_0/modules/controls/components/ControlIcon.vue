...
export default {
  ...
  props: {
    ...
    onClick: {
      type: Function,
      default: () =>
        console.warn("No onClick function was defined on this ControlIcon."),
    },
    buttonTitle: {
      type: String,
      default: "",
  ...
  computed: {
    ...
    iconClassOrSrc() {
      ...
      return this.iconName === "" || this.iconName.startsWith("bi-")
        ? this.iconName
        : `bi-${this.iconName}`;
    },
  },
...
<template>
  ...
  >
    ...
    <i
      v-if="
        !iconClassOrSrc.includes('masterportal') &&
        !iconClassOrSrc.includes('http')
      "
