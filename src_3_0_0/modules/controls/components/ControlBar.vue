...
export default {
  ...
  methods: {
     ...
     */
    checkIsVisible(key) {
      const supportedMapModes =
          this.$store.getters[
            `Controls/${changeCase.upperFirst(key)}/supportedMapModes`
          ],
        supportedDevices =
          this.$store.getters[
            `Controls/${changeCase.upperFirst(key)}/supportedDevices`
          ],
        supportedTreeTypes =
          this.$store.getters[
            `Controls/${changeCase.upperFirst(key)}/supportedTreeTypes`
          ];
