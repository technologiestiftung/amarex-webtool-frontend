            ...
            .then((layerLegends) => {
              layerLegends.legendInformation.forEach((legendInfo) => {
                if (
                  ...
                  legendInfo.styleObject.attributes.type === "circle" &&
                  legendInfo.label === feat.legendValue
                ) {
                  this.imgPathByFeature[feat.getId()] = svgFactory.createCircle(
                    legendInfo.styleObject,
                  );
                } else if (
                  legendInfo.geometryType === "LineString" &&
                  legendInfo.label === feat.legendValue
                ) {
                  this.imgPathByFeature[feat.getId()] = svgFactory.createLine(
                    legendInfo.styleObject,
                  );
                } else if (
                  ...
                  this.imgPathByFeature[feat.getId()] =
                    svgFactory.createPolygon(legendInfo.styleObject);
                }
              });
            });
        }
        ...
        <div>
          ...
          <div class="tab-content">
            <div
              ...
              :class="[
                'tab-pane fade show',
                feature.category === activeCategory ? 'active' : '',
              ]"
            >
                ...
                <table class="table table-hover">
                  <tbody>
                    ...
                    >
                      <td
                        v-if="
                          imgPathByFeature[feat.getId()].indexOf('</svg>') !==
                          -1
                        "
                      >
                      ...
                      <td v-else-if="imgPathByFeature[feat.getId()].length > 0">
                        <img
                          ...
                          :alt="
                            $t('common:modules.controls.orientation.imgAlt')
                          "
                        />
                      </td>
                      <td>
                        <p
                          v-for="(
                            featNearbyTitleText, iNearby
                          ) in feat.nearbyTitleText"
                        ...
                        <p>
                          {{
                            ...
                            " " +
                            $t(
                              "common:modules.controls.orientation.distanceUnit",
                            )
                          }}
                        </p>
                      </td>
