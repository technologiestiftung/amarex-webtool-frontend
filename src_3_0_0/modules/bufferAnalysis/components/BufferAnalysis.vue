...
export default {
  ...
  computed: {
    ...mapGetters("Modules/BufferAnalysis", [
      "bufferRadius",
      "selectOptions",
      "savedUrl",
    ]),
  ...
  methods: {
    ...mapMutations("Modules/BufferAnalysis", [
      "setSelectOptions",
      "setInputBufferRadius",
      "setTimerId",
      "setResultType",
      "setSelectedTargetLayer",
    ]),
    ...mapActions("Modules/BufferAnalysis", [
      "applyValuesFromSavedUrlBuffer",
  ...
  <div id="tool-bufferAnalysis">
    ...
    <div class="form-floating mb-3">
      <input
        ...
        type="number"
      />
      <label for="tool-bufferAnalysis-radiusTextInput">{{
        $t("common:modules.bufferAnalysis.rangeLabel")
      }}</label>
      <SliderItem
    ...
    <div class="form-floating mb-3">
      ...
      >
        <option :value="resultTypeEnum.WITHIN">
          {{ $t("common:modules.bufferAnalysis.overlapping") }}
        </option>
        <option :value="resultTypeEnum.OUTSIDE">
    ...
    <div class="d-flex justify-content-center row form-floating">
      <FlatButton
        ...
        :disabled="
          !selectedSourceLayer || !selectedTargetLayer || !bufferRadius
        "
