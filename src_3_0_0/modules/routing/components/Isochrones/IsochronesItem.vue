...
export default {
  ...
  computed: {
    ...mapGetters("Modules/Routing/Isochrones", [
      "isInputDisabled",
     ...
     */
    currentValue() {
      return this.settings.isochronesMethodOption === "DISTANCE"
        ? this.settings.distanceValue
     ...
     */
    maxIntervalValue() {
      return this.currentValue < this.settings.maxInterval
        ? this.currentValue
     ...
     */
    minIntervalValue() {
      return this.currentValue < this.settings.minInterval
        ? this.currentValue
...
<template>
  <div id="routing-isochrones">
    ...
    <template
      v-if="
        isochronesSettings.batchProcessing.enabled &&
        isochronesSettings.batchProcessing.active
      "
    >
      ...
      <div class="d-flex flex-column">
        <div class="col-12 d-grid gap-2">
          <button
            ...
            type="button"
            :disabled="
              waypoint.getCoordinates().length === 0 || isInputDisabled
            "
        ...
        >
          ...
          <span class="mb-2">{{
            $t("common:modules.routing.isochrones.legend")
          }}</span>
          <div
          ...
          >
            ...
            >
              ...
              <span>{{
                area.getOptimization() === "DISTANCE" ? "km" : "min"
              }}</span>
            </div>
          </div>
