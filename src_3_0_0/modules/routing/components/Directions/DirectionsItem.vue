...
<template>
  <div id="routing-directions">
    ...
    <template
      v-if="
        directionsSettings.batchProcessing.enabled &&
        directionsSettings.batchProcessing.active
      "
    >
    ...
    <template v-else>
      ...
      >
        ...
        <RoutingCoordinateInput
          ...
          @remove-waypoint="
            removeWaypoint({ index: waypoint.index, reload: true })
          "
      ...
      <div class="d-flex justify-content-between mt-4">
        <div class="d-flex">
          <span>
            {{ $t("common:modules.routing.directions.restrictedAreas") }}:</span
          >
          ...
          >
            ...
            >
              <title>
                {{
                  $t("common:modules.routing.directions.editRestrictedAreas")
                }}
              </title>
              <path
          ...
          >
            ...
            >
              <title>
                {{
                  $t("common:modules.routing.directions.deleteRestrictedAreas")
                }}
              </title>
              <path
    ...
    >
      <option
        v-for="option in preferencesFromConfig?.hasOwnProperty(
          settings.speedProfile,
        )
          ? preferencesFromConfig[settings.speedProfile]
          : constants.preferenceOptions"
        :id="option"
      ...
      >
        <div class="d-flex justify-content-between">
          <RoutingSpeedProfileIcon
            ...
            :tooltip="
              $t(
                'common:modules.routing.speedprofiles.' + settings.speedProfile,
              )
            "
          />
        ...
        >
          ...
          <div v-if="segment.displayDetails">
            <template
            ...
            >
              <button
                ...
                @mouseover="
                  highlightRoute({ coordsIndex: step.getWaypoints() })
                "
                ...
                @keydown.enter="
                  zoomToRoute({ coordsIndex: step.getWaypoints() })
                "
              >
        ...
        <button
          ...
          @mouseover="
            highlightRoute({
              coordsIndex: [
                waypoints[waypoints.length - 1].getIndexDirectionsLineString() -
                  1,
                waypoints[waypoints.length - 1].getIndexDirectionsLineString() +
                  1,
              ],
        ...
        >
          <span>B</span>
          <b class="ms-2">{{
            waypoints[waypoints.length - 1].getDisplayName()
          }}</b>
        </button>
