...
} from "../../../../js/directions/routing-ors-directions";
  ...
  describe("should fetchRoutingOrsDirections", () => {
    ...
    it("should throw error 404", async () => {
      ...
      try {
        ...
        expect(error.message).equal(
          "common:modules.routing.errors.noRouteFound",
        );
      }
    });
    ...
    it("should throw error 2003", async () => {
      ...
      try {
        ...
        expect(error.message).equal(
          "common:modules.routing.errors.avoidAreaBig",
        );
      }
    });
    ...
    it("should throw other error", async () => {
      ...
      try {
        ...
        expect(error.message).equal(
          "common:modules.routing.errors.errorRouteFetch",
        );
      }
    });
  });
  ...
  describe("getRoutingDirectionsSettingsUrl", () => {
    it("service url without backslash at the end", () => {
      ...
      expect(createdUrl.href).to.eql(
        service + "/v2/directions/driving-car/geojson",
      );
    });
