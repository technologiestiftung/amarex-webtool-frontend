...
describe("src_3_0_0/modules/routing/js/geosearch/routing-komoot-geosearch.js", () => {
    ...
    it("should process result correct", async () => {
          ...
          resolve({
            ...
            data: {
              ...
              features: [
                {
                  geometry: {
                    coordinates: [10.02344338987701, 53.5686328],
                    type: "Point",
                  },
                  type: "Feature",
                  properties: {
                    osm_id: 38148402,
                    extent: [10.0233599, 53.5686992, 10.0235412, 53.5685187],
                    country: "Deutschland",
                    city: "Hamburg",
                    countrycode: "DE",
                    postcode: "22085",
                ...
                },
                {
                  ...
                  properties: {
                    osm_type: "R",
                    osm_id: 284861,
                    extent: [10.0038075, 53.582101, 10.0378378, 53.5652488],
                    country: "Deutschland",
                    osm_key: "place",
                    city: "Hamburg",
                    countrycode: "DE",
      ...
      const result = await fetchRoutingKomootGeosearch("testsearch"),
        expectedResult = [
          ...
          new RoutingGeosearchResult([10.0127361, 53.5715093], "Uhlenhorst"),
        ];
  ...
  describe("should fetchRoutingKomootGeosearchReverse", () => {
    it("should process result correct", async () => {
      ...
      const result = await fetchRoutingKomootGeosearchReverse("testsearch"),
  ...
  describe("getRoutingKomootGeosearchUrl", () => {
    it("test params", () => {
      const mapBbox = [
          4.511345914707728, 0.00048315628956933926, 4.51134591633199,
      ...
      expect(createdUrl.searchParams.get("bbox")).to.deep.eql(
        mapBbox.join(","),
      );
    ...
    it("createUrl should respect questionmark in serviceUrl", () => {
      ...
      expect(decodeURI(createdUrl)).to.eql(
        service +
          "&lang=de&lon=10&lat=53.6&bbox=4.511345914707728%2C0.00048315628956933926%2C4.51134591633199%2C0.00048315466157288633&limit=1000&q=search",
      );
      expect(createdUrl.searchParams.get("lang")).to.eql("de");
      expect(createdUrl.searchParams.get("lon")).to.eql("10");
      expect(createdUrl.searchParams.get("lat")).to.eql("53.6");
