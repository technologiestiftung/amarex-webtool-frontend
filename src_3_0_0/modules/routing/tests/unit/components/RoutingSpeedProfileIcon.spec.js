...
describe("src_3_0_0/modules/routing/components/RoutingSpeedProfileIcon.vue", () => {
  ...
  it("renders CYCLING icon", () => {
    ...
    expect(wrapper.find(".routing-speed-profile-icon-CYCLING").exists()).to.be
      .true;
  });
  ...
  it("renders FOOT icon", () => {
    ...
    expect(wrapper.find(".routing-speed-profile-icon-FOOT").exists()).to.be
      .true;
  });
  ...
  it("renders WHEELCHAIR icon", () => {
    ...
    expect(wrapper.find(".routing-speed-profile-icon-WHEELCHAIR").exists()).to
      .be.true;
  });
});
