...
describe("src_3_0_0/modules/legend/store/gettersLegend.js", () => {
  ...
  it("urlParams", () => {
        ...
        legends: [
          {
            ...
            name: "layer1Name",
            legend: [
              "https://geodienste.hamburg.de/HH_WMS_Verwaltungsgrenzen?SERVICE=WMS&VERSION=1.3.0&REQUEST=GetLegendGraphic&FORMAT=image%2Fpng&LAYER=bezirke",
            ],
            position: 0,
          },
          {
            ...
            name: "layer2Name",
            legend: [
              "https://geodienste.hamburg.de/HH_WMS_Dauerzaehlstellen_Rad?SERVICE=WMS&VERSION=1.3.0&REQUEST=GetLegendGraphic&FORMAT=image%2Fpng&LAYER=dauerzaehlstellen_rad",
            ],
            position: 1,
          },
        ],
    ...
    expect(
      decodeURIComponent(urlParamsState.legends[0].legend[0]),
    ).to.be.equals(
      "https://geodienste.hamburg.de/HH_WMS_Verwaltungsgrenzen?SERVICE=WMS&VERSION=1.3.0&REQUEST=GetLegendGraphic&FORMAT=image%2Fpng&LAYER=bezirke",
    );
    ...
    expect(
      decodeURIComponent(urlParamsState.legends[1].legend[0]),
    ).to.be.equals(
      "https://geodienste.hamburg.de/HH_WMS_Dauerzaehlstellen_Rad?SERVICE=WMS&VERSION=1.3.0&REQUEST=GetLegendGraphic&FORMAT=image%2Fpng&LAYER=dauerzaehlstellen_rad",
    );
  });
