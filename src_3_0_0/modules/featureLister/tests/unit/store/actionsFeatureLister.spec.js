...
describe("src_3_0_0/modules/featureLister/store/actionsFeatureLister", () => {
    ...
    sinon.stub(layerCollection, "getOlLayers").returns([
      {
        ...
        features: [{ getAttributesToShow: () => "TestAttributes" }],
        geometryType: "Point",
      },
      {
        name: "zweiterLayer",
    ...
    it("handles the click event when clicking in a point-feature in the feature list view", () => {
      const featureIndex = 1,
        ...
        state = {
          shownFeatures: 20,
          features: [
            { erstesFeature: "first", getGeometry: () => "Point" },
            { zweitesFeature: "second", getGeometry: () => geometry },
            { drittesFeature: "third" },
          ],
          layer: {
            id: "layerId",
            geometryType: "Point",
  ...
  describe("hoverOverFeature", () => {
    const features = [
        { erstesFeature: "first", getId: () => "1" },
        { zweitesFeature: "second", getId: () => "2" },
        { drittesFeature: "third", getId: () => "3" },
      ],
      state = {
        shownFeatures: 2,
      };
