...
export default {
            ...
            if (format instanceof KML) {
                ...
                if (indices.length > 0) {
                    ...
                    const specialFormat = new KML({
                        ...
                        featuresNoPointNames = specialFormat.readFeatures(
                            datasrc.raw
                        );
        ...
        vectorLayer.setStyle((feature) => {
            ...
            if (!drawState) {
                ...
                if (geometryType === "Point" || geometryType === "MultiPoint") {
                    ...
                    console.warn(
                        "Geometry type not implemented: " + geometryType
                    );
                    style = new Style();
                }
    ...
    async addLayerConfig({ dispatch, state }, fileName) {
        const fileId = `${sanitizeSelector(fileName)}_${uniqueId(
            "importedFile_"
        )}`;
