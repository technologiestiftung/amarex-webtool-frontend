...
describe("src_3_0_0/modules/draw/components/DrawItem.vue", () => {
  let store, wrapper, componentData;
  ...
  it("sets focus to first input control", async () => {
    ...
    wrapper = shallowMount(DrawItemComponent, {
    ...
    expect(wrapper.find("#tool-draw-drawType").element).to.equal(
  ...
  it("should hide layer and disable controls", async () => {
    ...
    expect(wrapper.find("#tool-draw-undoInteraction").element.disabled).to.be
      .false;
    expect(wrapper.find("#tool-draw-redoInteraction").element.disabled).to.be
      .false;
    expect(wrapper.find("#tool-draw-deleteInteraction").element.disabled).to.be
      .false;
    expect(wrapper.find("#tool-draw-deleteAllInteraction").element.disabled).to
      .be.false;

    wrapper
      .find("#tool-draw-drawLayerVisible")
      .trigger("click")
      .then(() => {
        ...
        expect(wrapper.find("#tool-draw-drawInteraction").element.disabled).to
          .be.true;
        expect(wrapper.find("#tool-draw-undoInteraction").element.disabled).to
          .be.true;
        expect(wrapper.find("#tool-draw-redoInteraction").element.disabled).to
          .be.true;
        expect(wrapper.find("#tool-draw-editInteraction").element.disabled).to
          .be.true;
        expect(wrapper.find("#tool-draw-deleteInteraction").element.disabled).to
          .be.true;
        expect(wrapper.find("#tool-draw-deleteAllInteraction").element.disabled)
          .to.be.true;
      });
  });
