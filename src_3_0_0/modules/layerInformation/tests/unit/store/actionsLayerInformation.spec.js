...
const { startLayerInformation, additionalSingleLayerInfo, setMetadataURL } =
  actions;
  ...
  describe("initialize the store", () => {
    it("should initialize the LayerInformation", (done) => {
      ...
      testAction(
        ...
        [
          ...
          {
            type: "setMetadataURL",
            payload: layerConf.datasets[0].md_id,
            dispatch: true,
          },
          {
            type: "additionalSingleLayerInfo",
            payload: undefined,
            dispatch: true,
          },
        ],
    ...
    it("should call createLegendForLayerInfo, if legend is not created for layer with given id", (done) => {
      ...
      testAction(
        ...
        [
          {
            type: "Modules/Legend/setLayerInfoLegend",
            payload: {},
          },
          {
            type: "Modules/Legend/createLegendForLayerInfo",
            payload: "123",
            dispatch: true,
          },
          {
