...
describe("src_3_0_0/modules/wfsSearch/store/actionsWfsSearch.js", () => {
  ...
  describe("prepareModule", () => {
    const typeName = "someName",
      url = "myWfs",
      userHelp = "HALP";
    let getters, rootGetters, service;
    ...
    beforeEach(() => {
      ...
      rootGetters = {
        restServiceById: (id) =>
          id === 456 ? { url, featureType: typeName } : {},
      };
      service = { url };
    });
    ...
    it("should reset the module if the WFS is not given", () => {
      ...
      expect(dispatch.thirdCall.args[1]).to.eql(
        i18next.t("common:modules.wfsSearch.wrongConfig", { id: "wfsId" }),
      );
