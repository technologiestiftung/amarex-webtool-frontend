 ...
 * @returns {void}
 */
export default function SearchInterfaceKomootPhoton({
  serviceId,
  bbox,
  hitTemplate,
  limit,
...
SearchInterfaceKomootPhoton.prototype = Object.create(
 ...
 */
SearchInterfaceKomootPhoton.prototype.normalizeResults = function (
  searchResults,
) {
 ...
 * @returns {Object[]} The normalized search result.
 */
SearchInterfaceKomootPhoton.prototype.normalizeResult = function (
  searchResult,
) {
 ...
 */
SearchInterfaceKomootPhoton.prototype.createDisplayName = function (
  searchResult,
) {
 ...
 * @returns {String} The display name.
 */
SearchInterfaceKomootPhoton.prototype.createToolTipName = function (
  searchResult,
  displayName,
) {
  const properties = searchResult.properties;
 ...
 */
SearchInterfaceKomootPhoton.prototype.createPossibleActions = function (
  searchResult,
) {
  const resultCoordinates = searchResult.geometry.coordinates,
    coordinates = crs.transformToMapProjection(
      ...
      "EPSG:4326",
      [parseFloat(resultCoordinates[0]), parseFloat(resultCoordinates[1])],
    );
