...
export default {
  ...
  computed: {
    ...
    resultItems() {
      ...
      return this.limitedSortedSearchResults?.currentShowAllList.filter(
        (item) => item.category === this.currentAvailableCategories,
      );
    },
    ...
    hitTemplate() {
      if (this.resultItems) {
        return this.searchInterfaceInstances.find(
          (instance) =>
            instance.searchInterfaceId ===
            this.resultItems[0]?.searchInterfaceId,
        )?.hitTemplate;
      }
      return undefined;
    },
    ...
    <div id="search-bar-result-list">
      ...
      >
        <img
          v-if="
            limitedSortedSearchResults?.results[
              currentAvailableCategories + 'ImgPath'
            ]
          "
        ...
        <i
          ...
          :class="
            limitedSortedSearchResults?.results[
              currentAvailableCategories + 'Icon'
            ]
          "
        />
        ...
        {{
          ...
          ": " +
          limitedSortedSearchResults?.results[
            currentAvailableCategories + "Count"
          ] +
          "    " +
