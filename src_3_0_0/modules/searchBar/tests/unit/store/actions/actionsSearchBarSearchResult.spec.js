...
describe("src_3_0_0/modules/searchBar/store/actions/actionsSearchBarSearchResult.spec.js", () => {
  let dispatch, commit, getters, zoomLevel;
  ...
  describe("showInTree", () => {
    it("should call showLayer", () => {
      ...
      expect(dispatch.secondCall.args[0]).to.equals(
    ...
    it("should call addLayerToTopicTree and showLayer", () => {
      ...
      expect(dispatch.thirdCall.args[0]).to.equals(
        "Modules/LayerSelection/showLayer",
      );
  ...
  describe("showLayerInfo", () => {
    it("should call startLayerInformation - layer in layerConfig", () => {
      ...
      expect(commit.firstCall.args[0]).to.equals(
        "Modules/LayerSelection/setLayerInfoVisible",
      );
  ...
  describe("openGetFeatureInfo", () => {
    it("openGetFeatureInfo shall commit 'setGfiFeatures'", () => {
      const feature = {
        ...
        stubCreateGfiFeature = sinon
          .stub(wmsGFIUtil, "createGfiFeature")
          .returns(gfiFeature);

      openGetFeatureInfo({ commit }, { feature, layer });
      expect(commit.calledOnce).to.be.true;
      expect(commit.firstCall.args[0]).to.equals(
        "Modules/GetFeatureInfo/setGfiFeatures",
      );
