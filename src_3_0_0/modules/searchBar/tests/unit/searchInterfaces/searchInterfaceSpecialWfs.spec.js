...
describe("src_3_0_0/modules/searchBar/searchInterfaces/searchInterfaceSpecialWfs.js", () => {
          ...
          events: {
            onClick: {
              highlightFeature: {
                hit: {
                  coordinate: [
                    [565931.982, 5935196.323, 565869.067, 5935016.323],
                  ],
                  geometryType: "MultiPolygon",
                },
              },
  ...
  describe("getInteriorAndExteriorPolygonMembers", () => {
    it("should return correct coordinateArray", () => {
      ...
      expect(
        SearchInterface1.getInteriorAndExteriorPolygonMembers(
          xmlData.getElementsByTagNameNS("*", "Polygon"),
        ),
      ).to.deep.equals([[565762.142, 5936207.082, 565898.316, 5936207.367]]);
    });
  });
