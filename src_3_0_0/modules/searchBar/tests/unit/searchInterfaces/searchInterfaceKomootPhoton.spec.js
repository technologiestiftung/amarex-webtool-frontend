...
describe("src_3_0_0/modules/searchBar/searchInterfaces/searchInterfaceKomootPhoton.js", () => {
  ...
  describe("createSearchUrl", () => {
    ...
    it("should create the search url with extended GET parameters", () => {
      ...
      expect(SearchInterface1.createSearchUrl(searchInput)).to.equals(
        "test.url?lang=de&q=abc&bbox=9.6,53.3,10.4,53.8&lat=53.6&limit=10&lon=10",
      );
    });
  });
  ...
  describe("createDisplayName", () => {
    it("should create the display name for search result", () => {
      expect(SearchInterface1.createDisplayName(searchResults[0])).to.equals(
        "ABC-Straße, 20354 Hamburg - Neustadt",
      );
    });
    ...
    it("should create the display name for search result with county, if city is undefined", () => {
      ...
      expect(SearchInterface1.createDisplayName(searchResults[0])).to.equals(
        "ABC-Straße, 20354 Berlin - Neustadt",
      );
    });
    ...
    it("should create the display name for search result with city, if name is undefined", () => {
      ...
      expect(SearchInterface1.createDisplayName(searchResult)).to.equals(
        "Neue ABC-Straße 10, 20354 Hamburg - Neustadt",
      );
    });
  });
  ...
  describe("createToolTipName", () => {
    it("should create the tool tip name for search result", () => {
      ...
      expect(
        SearchInterface1.createToolTipName(searchResults[0], displaName),
      ).to.equals("ABC-Straße, 20354 Hamburg - Neustadt Deutschland");
    });
  });
