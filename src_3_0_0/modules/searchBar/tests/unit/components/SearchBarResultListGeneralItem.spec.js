...
describe("src_3_0_0/modules/searchBar/components/SearchBarResultListGeneralItem.vue", () => {
  ...
  describe("test the result item", () => {
    it("shows toolTip if available and check actionButtons", () => {
      ...
      expect(
        wrapper
          .find("#search-bar-result-list-general-itemBeidemNeuenKrahnStraße")
          .exists(),
      ).to.be.true;
    ...
    it("shows name if tooltip is undefined and check actionButtons", () => {
      ...
      expect(
        wrapper
          .find("#search-bar-result-list-general-itemBeidemNeuenKrahn2Adresse")
          .exists(),
      ).to.be.true;
      ...
      expect(
        wrapper.findAll("action-button-stub").at(0).attributes("actionname"),
      ).to.be.equals("setMarker");
      expect(
        wrapper.findAll("action-button-stub").at(1).attributes("actionname"),
      ).to.be.equals("startRouting");
    });
