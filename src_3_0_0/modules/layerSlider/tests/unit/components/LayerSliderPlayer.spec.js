...
describe("src_3_0_0/modules/layerSlider/components/LayerSliderPlayer.vue", () => {
  ...
  it("renders the layerSliderPlayer elements", () => {
    ...
    expect(wrapper.find("#module-layer-slider-player > div.progress").exists())
      .to.be.true;
    expect(
      wrapper.find("#module-layer-slider-player > div.input-group").exists(),
    ).to.be.true;
  });
  ...
  it("renders the progress-bar", () => {
    ...
    expect(
      wrapper
        .find("#module-layer-slider-player > div.progress > div.progress-bar")
        .exists(),
    ).to.be.true;
    expect(
      wrapper
        .find(
          "#module-layer-slider-player > div.progress > div.progress-bar > span.visually-hidden",
        )
        .exists(),
    ).to.be.true;
    expect(
      wrapper
        ...
        .text(),
    ).equals("common:modules.layerSlider.displayLayers");
  });
  ...
  it("renders the input-group with buttons", () => {
    ...
    expect(
      wrapper.findAll("#module-layer-slider-player > div.input-group > button")
        .length,
    ).equals(4);

    wrapper
      .findAll("#module-layer-slider-player > div.input-group > button")
    ...
    expect(
      wrapper
        .find("#module-layer-slider-player > div.input-group > label")
        .exists(),
    ).to.be.true;
    expect(
      wrapper
        .find("#module-layer-slider-player > div.input-group > input#title")
        .exists(),
    ).to.be.true;
  });
  ...
  it("renders the input-group button pause if play is clicked", async () => {
    ...
    await wrapper
      .find("#module-layer-slider-player > div.input-group > button#play")
      .trigger("click");
    ...
    expect(
      wrapper
        .find("#module-layer-slider-player > div.input-group > button#pause")
        .exists(),
    ).to.be.true;
  });
  ...
  it("skip to next layer with forward button", async () => {
    ...
    await wrapper
      .find("#module-layer-slider-player > div.input-group > button#forward")
      .trigger("click");
  ...
  it("skip to previous layer with backward button", async () => {
    ...
    await wrapper
      .find("#module-layer-slider-player > div.input-group > button#backward")
      .trigger("click");
    expect(store.getters["Modules/LayerSlider/activeLayer"].index).equals(2);
