...
describe("src_3_0_0/modules/layerSlider/store/actionsLayerSlider.js", () => {
  ...
  describe("sendModification", () => {
    it("sendModification", (done) => {
      ...
      testAction(
        sendModification,
        { layerId, visibility, transparency },
        {},
        {},
        [
          {
  ...
  describe("toggleLayerVisibility", () => {
    it("toggleLayerVisibility", (done) => {
      ...
      testAction(
        ...
        [
          {
            type: "sendModification",
            payload: { layerId: "123", visibility: true },
            dispatch: true,
          },
          {
            type: "sendModification",
            payload: { layerId: "456", visibility: false },
            dispatch: true,
          },
          {
            type: "sendModification",
            payload: { layerId: "789", visibility: false },
            dispatch: true,
          },
        ],
        {},
