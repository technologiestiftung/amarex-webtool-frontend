...
describe("buildCesiumImageLayer", () => {
  ...
  describe("takeOl3DScreenshot", () => {
    ...
    it("should return promise with expected result", async () => {
      ...
      await buildCesiumImageLayer
        .takeOl3DScreenshot(scene, { width: 0, height: 0 })
        .then((result) => {
  ...
  describe("createFakeExtent", () => {
    it("should return expected array", () => {
      const view = {
        ...
        pixels = [1, 1],
        result = [0.5, 0.5, 1.5, 1.5];

      expect(
        buildCesiumImageLayer.createFakeExtent(view, pixels),
  ...
  describe("createMapfishPrintImageLayerFromCesium", () => {
    it("should return mapfish print dialog as expected", async () => {
      ...
      expect(
        await buildCesiumImageLayer.createMapfishPrintImageLayerFromCesium(
          ol3d,
          { width: 0, height: 0 },
        ),
