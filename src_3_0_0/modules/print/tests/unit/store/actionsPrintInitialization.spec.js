...
describe("src_3_0_0/modules/print/store/actionsPrintInitialization.js", () => {
  ...
  describe("getGfiForPrint", function () {
    it("should set empty gfi for print", (done) => {
      ...
      testAction(
        ...
        { "Modules/GetFeatureInfo/currentFeature": null },
      );
    });
    it("should set gfi for print", (done) => {
      ...
      testAction(
        ...
        [
          {
            type: "setGfiForPrint",
            payload: ["TestProperties", "TestTitle", undefined],
          },
        ],
        {},
        done,
        {
          "Modules/GetFeatureInfo/currentFeature": feature,
          "Map/clickCoord": undefined,
        },
      );
    });
  });
  ...
  describe("getAttributeInLayoutByName", function () {
    it("should set nothing because gfi isn't available", (done) => {
      ...
      // action, payload, state, rootState, expectedMutationsAndActions, getters = {}, done, rootGetters
      testAction(getAttributeInLayoutByName, "gfi", state, {}, [], {}, done);
    });
  });
  ...
  describe("togglePostrenderListener", function () {
    it("should toggle the post render listener and should register listener", (done) => {
      ...
      testAction(
        ...
        [
          {
            type: "setVisibleLayer",
            payload: state.visibleLayerList,
            commit: true,
          },
  ...
  describe("setPrintLayers", function () {
    it("one layer is invisible in print scale, shows hint", () => {
      ...
      expect(dispatch.firstCall.args[0]).to.be.equals(
  ...
  describe("updateCanvasLayer", function () {
    it("should update to draw the print page rectangle onto the canvas when the map changes", (done) => {
      ...
      testAction(
        ...
        [
          {
            type: "Maps/unregisterListener",
            payload: { type: state.eventListener },
            dispatch: true,
          },
          {
            type: "chooseCurrentLayout",
            payload: state.layoutList,
            dispatch: true,
          },
          { type: "setEventListener", payload: "postrender", commit: true },
        ],
    ...
    it("creates the print Mask", (done) => {
      const evt = {
          ...
          frameState: {
            ...
            pixelToCoordinateTransform: [
              10.583327618336, 0, 0, -10.583327618336, 1104618.7926526342,
              7087941.480887591,
            ],
            viewState: {
        ...
        state = {
          ...
          scaleList: [
            500, 1000, 2500, 5000, 10000, 20000, 40000, 60000, 100000,
          ],
          optimalScale: 20000,
        },
        canvasOptions = {
      ...
      testAction(
        ...
        [
          ...
          {
            type: "drawPrintPage",
            payload: canvasPrintOptions,
            dispatch: true,
          },
          {
            type: "setPrintLayers",
            payload: state.optimalScale,
            dispatch: true,
          },
        ],
        {},
  ...
  describe("getOptimalResolution", function () {
    it("returns the optimal resolution", (done) => {
      ...
      testAction(
        ...
        [
          {
            type: "setOptimalResolution",
            payload: 4.262740006961495,
            commit: true,
          },
        ],
        {},
  ...
  describe("getPrintMapSize", function () {
    it("should commit the printMapSize", (done) => {
      ...
      testAction(
        ...
        [
          {
            type: "getAttributeInLayoutByName",
            payload: "map",
            dispatch: true,
          },
    ...
    it("should commit the scales", (done) => {
      const state = {
        mapAttribute: {
          clientInfo: {
            scales: [
              250000, 100000, 60000, 40000, 20000, 10000, 5000, 2500, 1000, 500,
            ],
          },
        },
      };
      ...
      testAction(
        ...
        [
          ...
          {
            type: "setScaleList",
            payload: state.mapAttribute.clientInfo.scales,
            commit: true,
          },
        ],
        {},
