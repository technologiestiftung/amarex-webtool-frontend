...
describe("src_3_0_0/modules/styleVT/components/StyleVT.vue", () => {
  let store, vectorTileLayerList, wrapper;
  ...
  it("should render a paragraph informing the user that no styleable layers are available if none are", () => {
    ...
    expect(wrapper.find("#module-styleVT-noStyleableLayers").exists()).to.be
      .true;
    expect(wrapper.find("#module-styleVT-styleableLayersAvailable").exists()).to
      .be.false;
  });
  ...
  it("sets focus to first input control", async () => {
    ...
    expect(wrapper.find("#module-styleVT-selectedLayerField").element).to.equal(
