...
export default {
  ...
  importFile({ state, dispatch, rootGetters }, datasrc) {
    ...
    try {
      ...
      alertingMessage = {
        category: "error",
        content: i18next.t(
          "common:modules.fileImport.alertingMessages.formatError",
          { filename: fileName },
        ),
      };
    ...
    features.forEach((feature) => {
      ...
      if (feature.getGeometry() === null) {
        ...
        alertingMessage = {
          category: "error",
          content: i18next.t(
            "common:modules.fileImport.alertingMessages.featureError",
          ),
        };
        ...
        geometries.forEach((geometry) => {
          ...
          if (
            crsPropName === "urn:ogc:def:crs:EPSG:6.6:4326" ||
    ...
    if (featureError) {
      alertingMessage = {
        category: "error",
        content: i18next.t(
          "common:modules.fileImport.alertingMessages.successPartly",
          { filename: fileName },
        ),
      };
    } else {
  ...
  importGeoJSON({ state, dispatch, rootGetters }, datasrc) {
    ...
    alertingMessage = {
      category: "success",
      content: i18next.t("common:modules.fileImport.alertingMessages.success", {
        filename: fileName,
      }),
    };
