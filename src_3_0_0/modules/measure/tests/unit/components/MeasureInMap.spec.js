...
describe("src_3_0_0/modules/measure/components/MeasureInMap.vue", () => {
  let store, wrapper, origcreateDrawInteraction, origdeleteFeatures;
  ...
  it("select element interaction produces expected mutations, actions, and updates", () => {
    ...
    expect(MeasureModule.mutations.setSelectedLineStringUnit.calledOnce).to.be
      .true;
  ...
  it("sets focus to first input control", async () => {
    ...
    expect(wrapper.find("#measure-tool-geometry-select").element).to.equal(
