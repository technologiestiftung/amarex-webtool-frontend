...
import {
  getVisibleLayersWithGroupLayersChildren,
  getVisibleWmsLayersAtResolution,
} from "../../../js/getLayers";
...
describe("src_3_0_0/modules/getFeatureInfo/js/getLayers.js", () => {
  describe("getVisibleLayersWithGroupLayersChildren", () => {
    it("returns the getVisibleLayersWithGroupLayersChildren with Group layers", () => {
      ...
      expect(getVisibleLayersWithGroupLayersChildren(layers))
        .to.be.an("array")
        .that.contains(layer1, layer2);
    });
  ...
  describe("getVisibleWmsLayersAtResolution", () => {
    let visibleSubjectDataLayerConfigs, layer1, layer2, layer3, grouplayer;
