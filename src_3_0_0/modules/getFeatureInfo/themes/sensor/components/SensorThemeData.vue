...
export default {
  ...
  computed: {
    ...
    firstColumnHeaderName: function () {
      return (
        this.feature.getTheme()?.params?.data?.firstColumnHeaderName ||
        this.$t(
          "common:modules.getFeatureInfo.themes.sensor.sensorData.firstColumnHeaderName",
        )
      );
    },
    ...
    splittedMappedProperties: function () {
      ...
      Object.entries(properties).forEach(([key, value]) => {
        ...
        properties[key] = Array.isArray(splittedValue)
          ? splittedValue
          : [splittedValue];
      });
    ...
    columnHeaders: function () {
      return this.feature
        .getProperties()
        [this.columnHeaderAttribute]?.split(" | ");
    },
  },
  created() {
    this.columnHeaderAttribute =
      this.feature.getTheme()?.params?.data?.columnHeaderAttribute ||
      this.columnHeaderAttribute;
  },
  methods: {
    isWebLink,
