...
} from "../../../js/processHistoricalDataByWeekdays.js";
...
describe("src_3_0_0/modules/getFeatureInfo/themes/sensor/js/processHistoricalDataByWeekdays.js", () => {
  ...
  describe("addIndex", function () {
    ...
    it("should return an array that is equal to input array for incorrect array input", function () {
      expect(addIndex(["test", "abc"]))
        .to.be.an("array")
        .that.includes("test", "abc");
    });
    it("should return array with index for correct array input", function () {
      ...
      expect(addIndex(historicalData))
        .to.be.an("array")
  ...
  describe("processHistoricalDataByWeekdays", function () {
    it("should return an array with seven empty arrays for undefined input", function () {
      expect(processHistoricalDataByWeekdays(undefined, undefined))
        .to.be.an("array")
        .to.have.deep.members([[], [], [], [], [], [], []]);
    });
    it("should return an array with seven empty arrays for empty array and empty string input", function () {
      expect(processHistoricalDataByWeekdays([], ""))
        .to.be.an("array")
        .to.have.deep.members([[], [], [], [], [], [], []]);
    });
    it("should return an array with seven empty arrays for empty array and empty string input", function () {
      expect(processHistoricalDataByWeekdays(["test", 1111, "abcd"], ""))
        .to.be.an("array")
        .to.have.deep.members([[], [], [], [], [], [], []]);
    });
    it("should return an array with seven arrays that contains divided data for correct data without lastDay input", function () {
      const beforeOneYear = dayjs().subtract(1, "years").format("YYYY-MM-DD"),
        ...
        historicalDataByWeekdays = processHistoricalDataByWeekdays(
          historicalDataWithIndex,
          startDate,
        );
