...
} from "../../../js/mathematicalOperations.js";

describe("src_3_0_0/modules/getFeatureInfo/themes/sensor/js/mathematicalOperations.spec.js", () => {
  describe("arrayPerHour", function () {
    it("should return an empty array for undefined input", function () {
      expect(arrayPerHour(undefined, undefined)).to.be.an("array").that.is
        .empty;
    });
    ...
    it("should return an array with data for correct input", function () {
      ...
      expect(arrayPerHour(1, dataPerHour))
        .to.be.an("array")
        .that.includes(0, 1, 0);
    });
  });
  ...
  describe("calculateArithmeticMean", function () {
    ...
    it("should return an empty array for undefined input", function () {
      ...
      expect(calculateArithmeticMean(dataPerHour))
        .to.be.an("array")
