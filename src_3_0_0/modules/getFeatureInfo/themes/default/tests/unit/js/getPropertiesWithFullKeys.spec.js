import {
  getPropertiesWithFullKeys,
  escapeTerm,
} from "../../../js/getPropertiesWithFullKeys";
import { expect } from "chai";

describe("src_3_0_0/modules/getFeatureInfo/themes/default/js/getPropertiesWithFullKeys.js", () => {
  describe("escapeTerm", () => {
  ...
  describe("getPropertiesWithFullKeys", () => {
    ...
    it("should use the given depth barrier", () => {
      ...
      expect(getPropertiesWithFullKeys(properties, "@", ".", 1)).to.deep.equal(
        expected1,
      );
      expect(getPropertiesWithFullKeys(properties, "@", ".", 3)).to.deep.equal(
        expected2,
      );
    });
