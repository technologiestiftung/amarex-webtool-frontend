...
describe("src_3_0_0/modules/menu/MenuContainerBodyRootItems.vue", () => {
  let store, sections, pathMainMenu, pathSecondaryMenu;
  ...
  it("contains a list element and a MenuContainerBodyRootItemElements in the main menu for each configured section item", () => {
    ...
    expect(
      wrapper.findAllComponents(MenuContainerBodyRootItemElement).length,
    ).to.be.equal(sections.length);
    expect(
      wrapper
        .findAll("#mp-menu-body-items-element-0-mainMenu")[0]
        .attributes("name"),
    ).to.be.equal(sections[0].name);
    expect(
      wrapper
        .findAll("#mp-menu-body-items-element-0-mainMenu")[0]
        .attributes("icon"),
    ).to.be.equal(sections[0].icon);
    expect(
      wrapper
        .findAll("#mp-menu-body-items-element-0-mainMenu")[0]
    ...
    expect(
      wrapper
        .findAll("#mp-menu-body-items-element-0-mainMenu")[0]
        .attributes("path"),
    ).to.be.equal(pathMainMenu.join(",") + ",0");

    expect(
      wrapper
        .findAll("#mp-menu-body-items-element-1-mainMenu")[0]
        .attributes("name"),
    ).to.be.equal(sections[1].name);
    expect(
      wrapper
        .findAll("#mp-menu-body-items-element-1-mainMenu")[0]
        .attributes("icon"),
    ).to.be.equal(sections[1].icon);
    expect(
      wrapper
        .findAll("#mp-menu-body-items-element-1-mainMenu")[0]
        .attributes("description"),
    ).to.be.equal(sections[1].description);
    expect(
      wrapper
        .findAll("#mp-menu-body-items-element-1-mainMenu")[0]
        .attributes("path"),
    ).to.be.equal(pathMainMenu.join(",") + ",1");

    expect(
      wrapper
        .findAll("#mp-menu-body-items-element-2-mainMenu")[0]
        .attributes("name"),
    ).to.be.equal(sections[2].name);
    expect(
      wrapper
        .findAll("#mp-menu-body-items-element-2-mainMenu")[0]
        .attributes("icon"),
    ).to.be.equal(sections[2].icon);
    expect(
      wrapper
        .findAll("#mp-menu-body-items-element-2-mainMenu")[0]
        .attributes("description"),
    ).to.be.equal(sections[2].description);
    expect(
      wrapper
        .findAll("#mp-menu-body-items-element-2-mainMenu")[0]
        .attributes("path"),
    ).to.be.equal(pathMainMenu.join(",") + ",2");
  });
  ...
  it("renders the component as secondary menu", () => {
    ...
    expect(wrapper.find("#mp-menu-body-items-secondaryMenu").exists()).to.be
      .true;
  });
  ...
  it("contains a list element and a MenuContainerBodyRootItemElements in the main menu for each configured section item", () => {
    ...
    expect(
      wrapper
        .findAll("#mp-menu-body-items-element-0-secondaryMenu")[0]
        .attributes("name"),
    ).to.be.equal(sections[0].name);
    expect(
      wrapper
    ...
    expect(
      wrapper
        .findAll("#mp-menu-body-items-element-0-secondaryMenu")[0]
        .attributes("path"),
    ).to.be.equal(pathSecondaryMenu.join(",") + ",0");

    expect(
      wrapper
        .findAll("#mp-menu-body-items-element-1-secondaryMenu")[0]
        .attributes("name"),
    ).to.be.equal(sections[1].name);
    expect(
      wrapper
    ...
    expect(
      wrapper
        .findAll("#mp-menu-body-items-element-1-secondaryMenu")[0]
        .attributes("path"),
    ).to.be.equal(pathSecondaryMenu.join(",") + ",1");

    expect(
      wrapper
        .findAll("#mp-menu-body-items-element-2-secondaryMenu")[0]
        .attributes("name"),
    ).to.be.equal(sections[2].name);
    expect(
      wrapper
    ...
    expect(
      wrapper
        .findAll("#mp-menu-body-items-element-2-secondaryMenu")[0]
        .attributes("path"),
    ).to.be.equal(pathSecondaryMenu.join(",") + ",2");
  });
