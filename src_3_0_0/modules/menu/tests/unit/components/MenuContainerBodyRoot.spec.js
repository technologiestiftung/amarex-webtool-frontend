...
describe("src_3_0_0/modules/menu/MenuContainerBodyRoot.vue", () => {
  let store, mainMenu, mainMenuTitle, secondaryMenu, secondaryMenuTitle;
  ...
  it("renders the component in mainMenu with no sections", () => {
    ...
    expect(bodyWrapper.findComponent(MenuContainerBodyRootItems).exists()).to.be
      .false;
  });
  ...
  it("renders the component in secondaryMenu with no sections and no logo", () => {
    ...
    expect(bodyWrapper.exists()).to.be.true;
    expect(bodyWrapper.findComponent(MenuContainerBodyRootLogo).exists()).to.be
      .false;
  ...
  it("renders the component in mainMenu with sections", () => {
    ...
    expect(bodyWrapper.findComponent(MenuContainerBodyRootItems).exists()).to.be
      .true;
    expect(
      bodyWrapper.findAll("menu-container-body-root-items-stub").length,
    ).to.be.equals(2);
    expect(
      bodyWrapper
        .findAll("menu-container-body-root-items-stub")[0]
        .attributes("idappendix"),
    ).to.be.equals("mainMenu");
    expect(
      bodyWrapper
        .findAll("menu-container-body-root-items-stub")[0]
        .attributes("path"),
    ).to.be.equals("mainMenu,sections,0");
    expect(
      bodyWrapper
        .findAll("menu-container-body-root-items-stub")[1]
        .attributes("idappendix"),
    ).to.be.equals("mainMenu");
    expect(
      bodyWrapper
        .findAll("menu-container-body-root-items-stub")[1]
        .attributes("path"),
    ).to.be.equals("mainMenu,sections,1");
  });
  ...
  it("renders the component in secondaryMenu with sections and no logo", () => {
    ...
    expect(
      bodyWrapper
        .findAll("menu-container-body-root-items-stub")[0]
        .attributes("idappendix"),
    ).to.be.equals("secondaryMenu");
    expect(
      bodyWrapper
        .findAll("menu-container-body-root-items-stub")[0]
        .attributes("path"),
    ).to.be.equals("secondaryMenu,sections,0");
    expect(
      bodyWrapper
        .findAll("menu-container-body-root-items-stub")[1]
        .attributes("idappendix"),
    ...
    expect(
      bodyWrapper
        .findAll("menu-container-body-root-items-stub")[1]
        .attributes("path"),
    ).to.be.equals("secondaryMenu,sections,1");
  });
});
