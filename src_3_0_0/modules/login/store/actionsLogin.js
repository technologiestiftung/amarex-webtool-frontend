...
export default {
  ...
  async getAuthCodeUrl() {
    const oidcAuthorizationEndpoint =
        Config?.login?.oidcAuthorizationEndpoint ||
        "oidcAuthorizationEndpoint_not_defined_in_config.js",
      oidcClientId =
        Config?.login?.oidcClientId || "oidcClientId_not_defined_in_config.js",
      oidcRedirectUri =
        Config?.login?.oidcRedirectUri ||
        "oidcRedirectUri_not_defined_in_config.js",
      oidcScope =
        Config?.login?.oidcScope || "oidcScope_not_defined_in_config.js",
      url = await OIDC.getAuthCodeUrl(
