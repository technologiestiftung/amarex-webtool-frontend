...
const mutations = {
  ...
  addTimeSliderObject(state, timeSliderObject) {
    state.timeSlider.objects = [...state.timeSlider.objects, timeSliderObject];
  },
  setTimeSliderActive(
    { timeSlider },
    { active, currentLayerId, playbackDelay },
  ) {
    timeSlider.active = active;
    timeSlider.currentLayerId = currentLayerId;
    timeSlider.playbackDelay = playbackDelay;
  },
  setTimeSliderDefaultValue(
    { timeSlider: { currentLayerId, objects } },
    newValue,
  ) {
