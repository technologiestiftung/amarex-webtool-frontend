...
export default {
  ...
  methods: {
    ...
    ...mapMutations("Modules/WmsTime", [
      "setWindowWidth",
      "setTimeSliderActive",
      "setLayerSwiperActive",
      "setTimeSliderPlaying",
    ]),
    ...
    <div class="timeSlider-control-row">
      ...
      >
        <FlatButton
          ...
          :text="
            $t(
              minWidth && layerSwiper.active
                ? 'common:modules.wmsTime.timeSlider.buttons.deactivateLayerSwiper'
                : 'common:modules.wmsTime.timeSlider.buttons.layerSwiper',
            )
          "
        />
      </div>
