...
} from "../../../js/getAndMergeRawLayer.js";
import getNestedValues from "../../../../shared/js/utils/getNestedValues";
import {
  treeBaselayersKey,
  treeSubjectsKey,
} from "../../../../shared/js/utils/constants";
...
describe("src_3_0_0/app-store/js/buildTreeStructure.js", () => {
  ...
  before(() => {
    ...
    layerList = fs.readFileSync(
      "src_3_0_0/app-store/tests/unit/js/servicesMasterAuto.json",
      "utf8",
    );
  ...
  describe("build", () => {
    ...
    it("should return tree structured for active category and respect subject data layer configuration", () => {
      ...
      result = buildTreeStructure.build(
        getAndMergeAllRawLayers(),
        layerConfig,
        categories[0],
      ...
      firstFolders = result.elements[0].elements.filter(
        (el) => el.type === "folder",
      );
      secondFolders = result.elements[1].elements.filter(
        (el) => el.type === "folder",
      );
      layersInFirstFolders = result.elements[0].elements.filter(
        (el) => el.type === "layer",
      );
      layersInSecondFolders = result.elements[1].elements.filter(
        (el) => el.type === "layer",
      );
      ...
      expect(result.elements[0].name).to.be.equals(
        result.elements[0].elements[0].datasets[0].kategorie_opendata[0],
      );
      expect(result.elements[0].id).include("folder-");
      expect(result.elements[0].parentId).to.be.undefined;
      expect(result.elements[1].name).to.be.equals(
        result.elements[1].elements[0].datasets[0].kategorie_opendata[0],
      );
      ...
      expect(firstFolders[0].name).to.be.equals(
        firstFolders[0].elements[1].datasets[0].md_name,
      );
      expect(firstFolders[0].elements).to.be.an("array").to.have.lengthOf(2);
      expect(firstFolders[0].elements[0].id).to.be.equals("21999");
      expect(firstFolders[0].elements[0].parentId).to.be.equals(
        firstFolders[0].id,
      );
      expect(firstFolders[0].elements[0].showInLayerTree).to.be.true;
      expect(firstFolders[0].elements[0].type).to.be.equals("layer");
      expect(firstFolders[0].elements[0].name).not.to.be.equals(
        firstFolders[0].elements[0].datasets[0].md_name,
      );
      expect(firstFolders[0].elements[1].id).to.be.equals("22000");
      expect(firstFolders[0].elements[1].parentId).to.be.equals(
        firstFolders[0].id,
      );
      expect(firstFolders[0].elements[1].showInLayerTree).to.be.true;
      expect(firstFolders[0].elements[1].name).not.to.be.equals(
        firstFolders[0].elements[1].datasets[0].md_name,
      );
      expect(layersInFirstFolders).to.be.an("array").to.have.lengthOf(2);
      expect(layersInFirstFolders[0].id).to.be.equals("22799");
      expect(layersInFirstFolders[0].parentId).to.be.equals(
        result.elements[0].id,
      );
      expect(layersInFirstFolders[0].name).to.be.equals(
        layersInFirstFolders[0].datasets[0].md_name,
      );
      expect(layersInFirstFolders[1].id).to.be.equals("7887");
      expect(layersInFirstFolders[1].parentId).to.be.equals(
        result.elements[0].id,
      );
      expect(layersInFirstFolders[1].name).to.be.equals(
        layersInFirstFolders[1].datasets[0].md_name,
      );
      ...
      expect(secondFolders[0].name).to.be.equals(
        secondFolders[0].elements[1].datasets[0].md_name,
      );
      expect(secondFolders[0].elements).to.be.an("array").to.have.lengthOf(2);
      expect(secondFolders[0].elements[0].id).to.be.equals("96");
      expect(secondFolders[0].elements[0].parentId).to.be.equals(
        secondFolders[0].id,
      );
      expect(secondFolders[0].elements[0].name).not.to.be.equals(
        secondFolders[0].elements[0].datasets[0].md_name,
      );
      expect(secondFolders[0].elements[1].id).to.be.equals("95");
      expect(secondFolders[0].elements[1].parentId).to.be.equals(
        secondFolders[0].id,
      );
      expect(secondFolders[0].elements[1].name).not.to.be.equals(
        secondFolders[0].elements[1].datasets[0].md_name,
      );
      expect(secondFolders[0].name).to.be.equals(
        secondFolders[0].elements[1].datasets[0].md_name,
      ...
      expect(secondFolders[1].name).to.be.equals(
        secondFolders[1].elements[1].datasets[0].md_name,
      );
      expect(secondFolders[1].elements[0].id).to.be.equals("1102");
      expect(secondFolders[1].elements[0].parentId).to.be.equals(
        secondFolders[1].id,
      );
      expect(secondFolders[1].elements[0].name).not.to.be.equals(
        secondFolders[1].elements[0].datasets[0].md_name,
      );
      expect(secondFolders[1].elements[1].id).to.be.equals("1103");
      expect(secondFolders[1].elements[1].parentId).to.be.equals(
        secondFolders[1].id,
      );
      expect(secondFolders[1].elements[1].name).not.to.be.equals(
        secondFolders[1].elements[1].datasets[0].md_name,
      );

      expect(layersInSecondFolders).to.be.an("array").to.have.lengthOf(2);
      expect(layersInSecondFolders[0].id).to.be.equals("685");
      expect(layersInSecondFolders[0].parentId).to.be.equals(
        result.elements[1].id,
      );
      expect(layersInSecondFolders[0].name).to.be.equals(
        layersInSecondFolders[0].datasets[0].md_name,
      );
      expect(layersInSecondFolders[1].id).to.be.equals("182");
      expect(layersInSecondFolders[1].parentId).to.be.equals(
        result.elements[1].id,
      );
      expect(layersInSecondFolders[1].name).to.be.equals(
        layersInSecondFolders[1].datasets[0].md_name,
      );
    });
    ...
    it("should return tree structured for active category containing a wms-time layer", () => {
      ...
      expect(result.elements[1].elements[0].name).to.be.equals(
        result.elements[1].elements[0].datasets[0].md_name,
      );
    });
    ...
    it("should return tree structured for second category", () => {
      ...
      thirdFolders = result.elements[2].elements.filter(
        (el) => el.type === "folder",
      );
      layersInFirstFolders = result.elements[0].elements.filter(
        (el) => el.type === "layer",
      ...
      layersInThirdFolders = result.elements[2].elements.filter(
        (el) => el.type === "layer",
      );
      ...
      expect(folders[0].name).to.be.equals(
        firstFolders[0].elements[0].datasets[0].kategorie_inspire[0],
      );
      expect(folders[0].id).include("folder-");
      expect(folders[0].parentId).to.be.undefined;
      expect(folders[1].name).to.be.equals(
        secondFolders[0].elements[0].datasets[0].kategorie_inspire[0],
      );
      expect(folders[1].id).include("folder-");
      expect(folders[1].parentId).to.be.undefined;
      expect(folders[2].name).to.be.equals(
        thirdFolders[0].elements[0].datasets[0].kategorie_inspire[0],
      );
      ...
      expect(thirdFolders[0].name).to.be.equals(
        thirdFolders[0].elements[0].datasets[0].md_name,
      );
      ...
      expect(thirdFolders[0].elements[0].parentId).to.be.equals(
        thirdFolders[0].id,
      );
      expect(thirdFolders[0].elements[0].name).not.to.be.equals(
        thirdFolders[0].elements[0].datasets[0].md_name,
      );
      expect(thirdFolders[0].elements[1].id).to.be.equals("22000");
      expect(thirdFolders[0].elements[1].parentId).to.be.equals(
        thirdFolders[0].id,
      );
      expect(thirdFolders[0].elements[1].name).not.to.be.equals(
        thirdFolders[0].elements[1].datasets[0].md_name,
      );
      expect(layersInThirdFolders[0].id).to.be.equals("22799");
      expect(layersInThirdFolders[0].parentId).to.be.equals(
        result.elements[2].id,
      );
      expect(layersInThirdFolders[0].name).to.be.equals(
        layersInThirdFolders[0].datasets[0].md_name,
      );
      expect(layersInThirdFolders[1].id).to.be.equals("685");
      expect(layersInThirdFolders[1].parentId).to.be.equals(
        result.elements[2].id,
      );
      expect(layersInThirdFolders[1].name).to.be.equals(
        layersInThirdFolders[1].datasets[0].md_name,
      );
      expect(layersInThirdFolders[2].id).to.be.equals("7887");
      expect(layersInThirdFolders[2].parentId).to.be.equals(
        result.elements[2].id,
      );
      expect(layersInThirdFolders[2].name).to.be.equals(
        layersInThirdFolders[2].datasets[0].md_name,
      );
      expect(layersInThirdFolders[3].id).to.be.equals("182");
      expect(layersInThirdFolders[3].parentId).to.be.equals(
        result.elements[2].id,
      );
      expect(layersInThirdFolders[3].name).to.be.equals(
        layersInThirdFolders[3].datasets[0].md_name,
      );
    });
    ...
    it("should return tree structured for third category", () => {
      ...
      fourthFolders = result.elements[3].elements.filter(
        (el) => el.type === "folder",
      );
      layersInFirstFolders = result.elements[0].elements.filter(
        (el) => el.type === "layer",
      ...
      layersInFourthFolders = result.elements[3].elements[0].elements.filter(
        (el) => el.type === "layer",
      );
      ...
      expect(folders[0].name).to.be.equals(
        layersInFirstFolders[0].datasets[0].kategorie_organisation,
      );
      expect(folders[0].id).include("folder-");
      expect(folders[0].parentId).to.be.undefined;
      expect(folders[1].name).to.be.equals(
        layersInSecondFolders[0].datasets[0].kategorie_organisation,
      );
      expect(folders[1].id).include("folder-");
      expect(folders[1].parentId).to.be.undefined;
      expect(folders[2].name).to.be.equals(
        layersInThirdFolders[0].datasets[0].kategorie_organisation,
      );
      expect(folders[2].id).include("folder-");
      expect(folders[2].parentId).to.be.undefined;
      expect(folders[3].name).to.be.equals(
        layersInFourthFolders[0].datasets[0].kategorie_organisation,
      );
      ...
      expect(firstFolders[1].elements[0].parentId).to.be.equals(
        firstFolders[1].id,
      );
      expect(firstFolders[1].elements[0].name).not.to.be.equals(
        firstFolders[1].elements[0].datasets[0].md_name,
      );
      expect(firstFolders[1].elements[1].id).to.be.equals("1103");
      expect(firstFolders[1].elements[1].parentId).to.be.equals(
        firstFolders[1].id,
      );
      expect(firstFolders[1].elements[1].name).not.to.be.equals(
        firstFolders[1].elements[1].datasets[0].md_name,
      );
      ...
      expect(fourthFolders[0].name).to.be.equals(
        layersInFourthFolders[0].datasets[0].md_name,
      );
      expect(fourthFolders[0].id).include("folder-");
      expect(fourthFolders[0].parentId).to.be.equals(result.elements[3].id);
      expect(result.elements[3].elements.filter((el) => el.type === "layer"))
        .to.be.an("array")
        .to.have.lengthOf(0);
      expect(layersInFourthFolders).to.be.an("array").to.have.lengthOf(2);
      expect(layersInFourthFolders[0].id).to.be.equals("21999");
      expect(layersInFourthFolders[0].parentId).to.be.equals(
        result.elements[3].elements[0].id,
      );
      expect(layersInFourthFolders[0].name).not.to.be.equals(
        layersInFourthFolders[0].datasets[0].md_name,
      );
      expect(layersInFourthFolders[1].id).to.be.equals("22000");
      expect(layersInFourthFolders[1].parentId).to.be.equals(
        result.elements[3].elements[0].id,
      );
      expect(layersInFourthFolders[1].name).not.to.be.equals(
        layersInFourthFolders[1].datasets[0].md_name,
      );
    });
  });
  describe("setIdsAtFolders", () => {
    it("should set ids and parentIds", () => {
      ...
      expect(folderConfig.elements[0].elements[0].parentId).to.be.equals(
        folderConfig.elements[0].id,
      );
      expect(folderConfig.elements[0].elements[1].id).to.be.equals("2430");
      expect(folderConfig.elements[0].elements[1].parentId).to.be.equals(
        folderConfig.elements[0].id,
      );
      expect(folderConfig.elements[0].elements[2].id).to.be.equals("2429");
      expect(folderConfig.elements[0].elements[2].parentId).to.be.equals(
        folderConfig.elements[0].id,
      );
      expect(folderConfig.elements[0].elements[3].id).include("folder-");
      expect(folderConfig.elements[0].elements[3].parentId).to.be.equals(
        folderConfig.elements[0].id,
      );
      expect(folderConfig.elements[0].elements[3].elements[0].id).to.be.equals(
        "1103",
      );
      expect(
        folderConfig.elements[0].elements[3].elements[0].parentId,
      ).to.be.equals(folderConfig.elements[0].elements[3].id);
    });
  });
});
