        ...
        superInitialize: function () {
            this.listenTo(this, {
                "change:isActive": function (model, value) {
                    const gfiModel = model.collection
                        ? model.collection.findWhere({ id: "gfi" })
                        : undefined;
                    let activeTools = [];
                    ...
                    if (value) {
                        ...
                        activeTools = model.collection
                            ? model.collection.where({ isActive: true })
                            : undefined;
        ...
        superChangeLang: function () {
            if (typeof this.get("i18nextTranslate") !== "function") {
                if (this.get("useConfigName") === true) {
                    ...
                    typeof this.get("nameTranslationKey") === "string" &&
                    i18next.exists(this.get("nameTranslationKey"))
                ) {
